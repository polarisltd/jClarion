   ...
   INCLUDE('abreport.inc'),ONCE
                     ...
                     MAP
                       INCLUDE('COOKB004.INC'),ONCE        !Local module procedure declarations
                     END


PrintING:Keyname PROCEDURE                            !Generated from procedure template - Report
...
report               REPORT,AT(1000,1540,6000,7460),PRE(RPT),FONT('Arial',10,,),THOUS
                       HEADER,AT(1000,1000,6000,540)
                         STRING('Print the ingredients File by ING:Keyname'),AT(0,20,6000,220),CENTER,FONT(,,,FONT:bold)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintING:Keyname')
...
!  SELF.setICON()
  ...
  ThisReport.Init(Process:View, Relate:ingredients, ?Progress:PctText, Progress:Thermometer, ProgressMgr, ING:name)
  ThisReport.CaseSensitiveValue = FALSE
  ThisReport.AddSortOrder(ING:Keyname)
