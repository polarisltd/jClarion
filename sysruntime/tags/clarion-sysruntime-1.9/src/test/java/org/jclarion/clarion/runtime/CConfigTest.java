...
public class CConfigTest extends TestCase {
    ...
    {
        CConfigImpl c = new CConfigImpl("test.ini");
    ...
    {
        CConfigImpl i1 = new CConfigImpl("test.ini");
        CConfigImpl i2 = new CConfigImpl("test.ini");
    ...
    {
        assertEquals("10.100.100.1",CConfig.getProperty("LInternetSpares","host",null,"test.ini").toString());
        assertEquals("10.100.100.1",CConfig.getProperty("LInternetSpares","host","def","test.ini").toString());
        assertEquals("10.100.100.1",CConfig.getProperty("LInternetSpares","Host","def","test.ini").toString());
        assertEquals("10.100.100.1",CConfig.getProperty("LInternetspares","Host","def","test.ini").toString());
        assertEquals("def",CConfig.getProperty("LInternetSpares","hosty","def","test.ini").toString());
        assertEquals("",CConfig.getProperty("LInternetSpares","hosty",null,"test.ini").toString());
    }

    public void testConversionOnlyHappensOnce()
    {
        CConfigImpl c1 = new CConfigImpl("test.ini");
        c1.setProperty("test","key","value");
        assertEquals("value",c1.getProperty("test","key"));
        c1.join();
        
        c1 = new CConfigImpl("test.ini");
        assertEquals("value",c1.getProperty("test","key"));
    }
    ...
    {
        CConfigImpl c1 = new CConfigImpl("test.ini");
        CConfigImpl c2 = new CConfigImpl("test.ini");
    ...
    {
        CConfig.setProperty("tsection","key","\\\\Escaped","test.ini");
        CConfig.getInstance("test.ini");
        assertEquals("\\\\Escaped",CConfig.getProperty("tsection","key","","test.ini").toString());
    }
    
    public void testSetProperty()
    {
        for (int scan=1;scan<100;scan++) {
            CConfig.setProperty("tsection","key"+scan,"Val "+scan,"test.ini");
        }

        for (int scan=1;scan<100;scan++) {
            assertEquals("Val "+scan,CConfig.getProperty("tsection","key"+scan,null,"test.ini").toString());
        }

        for (int scan=1;scan<100;scan++) {
            CConfig.setProperty("tSection","kEy"+scan,"Val2 "+scan,"test.ini");
        }

        for (int scan=1;scan<100;scan++) {
            assertEquals("Val2 "+scan,CConfig.getProperty("tsection","key"+scan,null,"test.ini").toString());
        }
        ...
        CConfig.getInstance("test.ini").join();
