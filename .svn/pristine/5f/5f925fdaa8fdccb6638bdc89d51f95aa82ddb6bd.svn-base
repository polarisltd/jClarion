...
public class ClarionApplicationTest extends SwingTC {
    ...
    public void testStatusBar() throws InterruptedException
    {
        ...
        sb = ca.getStatusPane().getStatusBar();
        ...
        assertEquals(ca.widthDialogToPixels(50),sb.getComponent(1).getWidth());

        ca.setProperty(Prop.STATUS,2,40);
        waitForEventQueueToCatchup();
        sb = ca.getStatusPane().getStatusBar(); 
        assertEquals(ca.widthDialogToPixels(40),sb.getComponent(1).getWidth());
        ...
        getRobot().mousePress(w1.getWindow());
    ...
    public void testDefaultButtonSupressedWithAlert() throws InterruptedException
    {
        ...
        TestRunnable r = new TestRunnable() {
            ...
            public void test() throws InterruptedException 
            {
                ...
                assertTrue(ec.getComponent().hasFocus());
    ...
    public void testPostCrossThreadEvents()
    {
        ...
        TestRunnable r = new TestRunnable() {
            ...
            public void test() {
                assertNull(Clarion.getWindowTarget());
                CWin.post(Event.CLOSEWINDOW,null,new ClarionNumber(tid));
            }
        };
    ...
    public void testPostCrossThreadEventsCloseDown()
    {
        ...
        TestRunnable r = new TestRunnable() {
            ...
            public void test() {
                assertNull(Clarion.getWindowTarget());
                CWin.post(Event.CLOSEDOWN,null,new ClarionNumber(tid));
            }
        };
