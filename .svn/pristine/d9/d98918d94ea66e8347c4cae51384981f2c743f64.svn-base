...
public class ClarionString extends ClarionObject 
{
    ...
    public ClarionObject getThreadLockedClone()
    {
        ...
        return new ClarionString(this,true);
    }
    
    public ClarionString(ClarionString base,boolean lock)
    {
        super(base,lock);
    ...
    public ClarionString[] setOverAndDim(ClarionMemoryModel over,int size)
    {
        ClarionString r[] = dim(size);
        setOver(r,over);
        return r;
    }
