    ...
    public void constructSwingComponent(Container parent) {
        ...
        if (isProperty(Prop.PASSWORD)) {
            ...
            field = new JTextField() {
				private static final long serialVersionUID = 8427934174706016528L;
				private Dimension ps=null;
            	
				@Override
				public Dimension getPreferredSize() {
					if (ps!=null) {
						return new Dimension(ps);
					}
				...
				public void setPreferredSize(Dimension preferredSize) {
					ps=new Dimension(preferredSize);
