...
public class ClarionQueue extends ClarionGroup implements ClarionQueueReader
{
            ...
            if (base.value!=null) {
                ...
                if (base.value.getClass()!=value.getClass()) {
                    ...
                    try {
                        ...
                        ((ClarionMemoryModel)base.value).deserialize(sos.getInputStream());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    return;
    ...
    public static class Order implements Comparator<Record>
    {
        ...
        public Order(ClarionQueue base)
        {
            this.base=base;
        }
        
        public Order(ClarionQueue base,String s) {
            this.base=base;
            s=s.trim();
    ...
    {
        synchronized(data) {
            changeActiveSortOrder(new Order(this,order.toString()));
        }
    ...
    {
        get(new Order(this,order.toString()));
    }
