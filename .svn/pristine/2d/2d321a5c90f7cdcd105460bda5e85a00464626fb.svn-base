   ...
   INCLUDE('abwindow.inc'),ONCE
                     ...
                     MAP
                       INCLUDE('COOKB015.INC'),ONCE        !Local module procedure declarations
                     END


Selectrecipe PROCEDURE                                !Generated from procedure template - Window
...
ViewPosition           STRING(1024)                   !Entry's view position
                     END
QuickWindow          WINDOW('Select a recipe Record'),AT(,,358,188),FONT('MS Sans Serif',8,,),IMM,HLP('Selectrecipe'),SYSTEM,GRAY,RESIZE,MDI
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Selectrecipe')
