   ...
   INCLUDE('abreport.inc'),ONCE
                     ...
                     MAP
                       INCLUDE('COOKB007.INC'),ONCE        !Local module procedure declarations
                     END


PrintREC:Keyname PROCEDURE                            !Generated from procedure template - Report
...
report               REPORT,AT(1000,1720,6000,7280),PRE(RPT),FONT('Arial',10,,),THOUS
                       HEADER,AT(1000,1000,6000,720)
                         STRING('Print the recipe File by REC:Keyname'),AT(0,20,6000,220),CENTER,FONT(,,,FONT:bold)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintREC:Keyname')
...
!  SELF.setICON()
  ...
  ThisReport.Init(Process:View, Relate:recipe, ?Progress:PctText, Progress:Thermometer, ProgressMgr, REC:name)
  ThisReport.CaseSensitiveValue = FALSE
  ThisReport.AddSortOrder(REC:Keyname)
