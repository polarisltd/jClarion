...
public class SheetTest extends SwingTC {
    ...
    public void testDisabledSheets()
    {
        ...
        e2.setText("@n10.2");
        e2.setAt(15,35,100,20);
        t2.add(e2);

        EntryControl e3 = new EntryControl();
        e3.setText("@n10.2");
        e3.setAt(25,35,100,20);
        t3.add(e3);
        ...
        getRobot().key(KeyEvent.VK_2,KeyEvent.ALT_MASK);
        ...
        getRobot().key(KeyEvent.VK_3,KeyEvent.ALT_MASK);
        assertTrue(w.accept());
    ...
    public void testKeyTraversal()
    {
        ...
        ButtonControl n1 = new ButtonControl();
        n1.setText("here");
        n1.setAt(5,150,100,20);
        w.add(n1);
        ...
        getRobot().key(KeyEvent.VK_TAB,KeyEvent.CTRL_MASK);
        ...
        assertTrue(w.accept());
        assertEquals(Event.SELECTED,CWin.event());
        assertEquals(n1.getUseID(),CWin.field());
        w.consumeAccept();
