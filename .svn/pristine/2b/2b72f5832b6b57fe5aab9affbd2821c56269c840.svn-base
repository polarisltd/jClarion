...
public class Lexer 
{
    ...
    {
        System.err.println("ERROR:"+msg+" near line:"+reader.getLineCount()+" ("+name+")");
        debug(msg);
    ...
    public void error(String msg,Throwable t)
    {
        System.err.println("ERROR:"+msg+" near line:"+reader.getLineCount()+" ("+name+")");
        debug(msg);
        throw new ClarionCompileError(msg+" near line:"+reader.getLineCount()+" ("+name+")",t);
    }
