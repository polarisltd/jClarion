...
public class TextOverlapTest extends TestCase
{
    ...
    public void testTextFlowOverlap() throws InterruptedException
    {
    	...
    	assertPage(p,"Bouncy Bouncy, Oh such a good time.Bouncy\n"+
			...
			"Bouncy, oh such a good time.Bouncy Bouncy, White\n"+
			"socks slipping down.Bouncy Bouncy, Styletos are a\n"+
			"no no.\n"+
			"Bouncy Bouncy oh, Bouncy Bouncy oh.Everytime i\n"+
			"bounce i feel i could touch the skyee\n"+
    	...
    	assertPage(p,"Bouncy, oh such a good time.Bouncy Bouncy, White\n"+
			"socks slipping down.Bouncy Bouncy, Styletos are a\n"+
			"no no.\n"+
			"Bouncy Bouncy oh, Bouncy Bouncy oh.Everytime i\n"+
			"bounce i feel i could touch the skyee\n"+
