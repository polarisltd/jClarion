...
public class VariableParserTest extends TestCase {
	...
	public void setUp()
    {
        this.compiler=new ClarionCompiler();
    }
    ...
    public void testSimpleByte()
    {
        ...
        assertVariable("ClarionArray<ClarionNumber> anon=Clarion.newNumber(2).setEncoding(ClarionNumber.BYTE).dim(10)","BYte(2),dim(10)");
        
        assertVariable("ClarionArray<ClarionArray<ClarionNumber>> anon=Clarion.newNumber(2).setEncoding(ClarionNumber.BYTE).dim(15/5).dim(10)","BYte(2),dim(10),dim(15/5)");
    }
    ...
    {
        assertVariable2("v1","ClarionNumber v1=Clarion.newNumber().setEncoding(ClarionNumber.BYTE)","v1 byte");
        assertVariable2("v2","ClarionNumber v2=Clarion.newNumber().setEncoding(ClarionNumber.BYTE)","v2 like(v1)");
    }

    public void testLikeDim()
    {
        Variable v1 = assertVariable2("v1","ClarionArray<ClarionNumber> v1=Clarion.newNumber().setEncoding(ClarionNumber.BYTE).dim(1)","v1 byte,dim(1)");
        compiler.getScope().addVariable(v1);
        assertVariable2("v2","ClarionArray<ClarionNumber> v2=Clarion.newNumber().setEncoding(ClarionNumber.BYTE).dim(1)","v2 like(v1)");
    }
    ...
    public Variable assertVariable2(String key,String out,String in)
    {
        ...
        Variable result = compiler.getScope().getVariable(key);
        String r = result.generate();
        assertEquals(r,out,r);
