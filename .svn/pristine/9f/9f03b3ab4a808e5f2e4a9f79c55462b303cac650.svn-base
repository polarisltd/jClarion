...
public class ClassedVariable extends Variable
{
    ...
    public ClassedVariable(String name,ExprType type,JavaClass clazz,boolean reference,boolean st)
    {
        super(name,type,reference,st);
        this._clazz=clazz;
    }

    public ClassedVariable(String label, DanglingExprType cet,boolean reference,boolean st)
    {
    ...
    public Variable clone() {
        ...
        if (_clazz!=null) {
            return new ClassedVariable(getName(),getType(),_clazz,isReference(),isStatic());
        } else {
            return new ClassedVariable(getName(),dangle,isReference(),isStatic());
        }
    }
