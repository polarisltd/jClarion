...
public class SystemRegistry {
    ...
    protected void init()
    {
        ...
        register(
         PatternRewriter.create(null,"help"," // help $",ExprType.string).call()
        ...
        ,PatternRewriter.create(ExprType.string,"all","$.all()",ExprType.string).call()
        ,PatternRewriter.create(ExprType.rawstring,"replace","$.replace($,$)",ExprType.rawstring,ExprType.rawstring,ExprType.rawstring).call()
        ,PatternRewriter.create(ExprType.rawstring,"replaceall","$.replaceAll($,$)",ExprType.rawstring,ExprType.rawstring,ExprType.rawstring).call()
        ,PatternRewriter.create(ExprType.rawstring,"replacefirst","$.replaceFirst($,$)",ExprType.rawstring,ExprType.rawstring,ExprType.rawstring).call()
        ,PatternRewriter.create(ExprType.rawboolean,"match","$.match($)",ExprType.string,ExprType.rawstring).call()
        ,PatternRewriter.create(ExprType.rawboolean,"match","$.match($,$)",ExprType.string,ExprType.rawstring,ExprType.rawint).call()
        ,PatternRewriter.create(ExprType.rawint,"strpos","$.strpos($)",ExprType.string,ExprType.rawstring).call()
        ,PatternRewriter.create(ExprType.rawint,"strpos","$.strpos($,$)",ExprType.string,ExprType.rawstring,ExprType.rawboolean).call()
        ,PatternRewriter.create(ExprType.rawstring,"quote","$.quote()",ExprType.string).call()
        ,PatternRewriter.create(ExprType.rawstring,"quote","$.quote($)",ExprType.string,ExprType.rawboolean).call()
        ,PatternRewriter.create(ExprType.rawstring,"unquote","$.unquote()",ExprType.string).call()
        );
        ...
        ,PatternRewriter.create(ExprType.rawstring,"age","CDate.age($,$)",ExprType.rawint).call().rt("runtime.CDate")
        );
        ...
        ,PatternRewriter.create(null,"pusherrors","CError.pushErrors()").call().rt("runtime.CError")
        ,PatternRewriter.create(null,"poperrors","CError.popErrors()").call().rt("runtime.CError")
        );
        ...
        ,PatternRewriter.create(null,"post","CWin.post(@)",ExprType.rawint).call().range(1,4).rt("runtime.CWin")
        ...
        ,PatternRewriter.create(null,"setposition","$.setAt($,$,$,$)",ExprType.window,ExprType.rawint).range(1,5).call()
        ...
        ,PatternRewriter.create(null,"getposition","CWin.getPosition($,$,$,$,$)",ExprType.window,ExprType.number).range(1,5).call().rt("runtime.CWin")
        ...
        ,PatternRewriter.create(ExprType.rawint,"create","CWin.createControl($,$,$,$)",ExprType.rawint).call().range(2,4).rt("runtime.CWin")
        ...
        ,PatternRewriter.create(null,"notify","CWin.notify(@)",ExprType.rawint,ExprType.rawint,ExprType.any).call().range(1,3).rt("runtime.CWin")
        ,PatternRewriter.create(ExprType.rawboolean,"notification","CWin.notification(@)",ExprType.number,ExprType.number,ExprType.object).call().range(1,3).rt("runtime.CWin")
        ,PatternRewriter.create(ExprType.string,"dropid","CWin.getDropID($,$)",ExprType.any).call().range(0,2).rt("runtime.CWin")
        ,PatternRewriter.create(ExprType.string,"dragid","CWin.getDragID($,$)",ExprType.any).call().range(0,2).rt("runtime.CWin")
        ,PatternRewriter.create(null,"setdropid","CWin.setDropID($)",ExprType.rawstring).call().rt("runtime.CWin")
        ...
        ,PatternRewriter.create(null,"nomemo","$.setNoMemo()",ExprType.file).call()
        ...
        ,PatternRewriter.create(ExprType.rawint,"bytes","$.getBytes()",ExprType.file).call()
        ...
        ,PatternRewriter.create(null,"logout","ClarionFile.logout($,@)",ExprType.rawint,ExprType.file).call().rt("ClarionFile")
        ...
        ,PatternRewriter.create(null,"setlayout","// $.setLayout($)",ExprType.report,ExprType.rawint).call()
        ,PatternRewriter.create(null,"setlayout","// $.setLayout($)",ExprType.window,ExprType.rawint).call()
        );
        ...
        //,PatternRewriter.create(null,"dispose","// dispose $",ExprType.object).call()
         PatternRewriter.create(ExprType.rawint,"call","CRun.call($,$,$)",ExprType.rawstring,ExprType.rawstring,ExprType.rawint).range(2,3).call().rt("runtime.CRun")
        ,PatternRewriter.create(null,"unload","// unload $",ExprType.rawstring).call()
        ...
        ,new DisposeRewriter("dispose")
        ,PatternRewriter.create(null,"destroy","// destroy $",ExprType.group).call()
        );
        ...
        ,PatternRewriter.create(ExprType.rawstring,"getini","CConfig.getProperty($,$,$,$)",ExprType.rawstring).call().rt("runtime.CConfig")
        ,PatternRewriter.create(null,"putini","CConfig.setProperty($,$,$,$)",ExprType.rawstring).call().rt("runtime.CConfig")

        ,PatternRewriter.create(ExprType.rawstring,"getreg","CWindowsRegistry.get($,$,$,$)",ExprType.rawint,ExprType.rawstring,ExprType.rawstring,ExprType.number).call().range(2,4).rt("runtime.CWindowsRegistry")
        ,PatternRewriter.create(ExprType.rawint,"putreg","CWindowsRegistry.put($,$,$,$,$)",ExprType.rawint,ExprType.rawstring,ExprType.rawstring,ExprType.rawstring,ExprType.rawint).call().range(3,5).rt("runtime.CWindowsRegistry")
        ,PatternRewriter.create(ExprType.rawint,"deletereg","CWindowsRegistry.delete($,$,$)",ExprType.rawint,ExprType.rawstring,ExprType.rawstring).call().range(2,3).rt("runtime.CWindowsRegistry")
        ...
        ,PatternRewriter.create(ExprType.target,"target","CWin.getTarget()").call().rt("runtime.CWin")

        ,PatternRewriter.create(null,"remove","CFile.deleteFile($)",ExprType.rawstring).call().rt("runtime.CFile")
        ,PatternRewriter.create(null,"copy","CFile.copyFile($,$)",ExprType.rawstring,ExprType.rawstring).call().rt("runtime.CFile")
        ,PatternRewriter.create(null,"copy","$.copyTo($)",ExprType.file,ExprType.rawstring).call()
...
//      ,PatternRewriter.create(ExprType.any,"choose","CRun.choose($,new ClarionObject[] { @ })",ExprType.rawint,ExprType.any).call().rt("runtime.CRun","ClarionObject").min(3)
        ...
        ,PatternRewriter.create(ExprType.rawint,"instance","CMemory.instance($,$)",ExprType.object,ExprType.rawint).call().range(1,2).rt("runtime.CMemory")
        ...
        register(
         PatternRewriter.create(JavaPrec.CREATE,ExprType.getBasicJavaMapping(IMutex.class),"newmutex","new IMutex()").call().rt("runtime.concurrent.IMutex")
        ,PatternRewriter.create(JavaPrec.CREATE,ExprType.getBasicJavaMapping(ISemaphore.class),"newsemaphore","new ISemaphore($,$)",ExprType.rawint).range(0,2).call().rt("runtime.concurrent.ISemaphore")
        ,PatternRewriter.create(JavaPrec.CREATE,ExprType.getBasicJavaMapping(ICriticalSection.class),"newcriticalsection","new ICriticalSection()").call().rt("runtime.concurrent.ICriticalSection")
        ,PatternRewriter.create(JavaPrec.CREATE,ExprType.getBasicJavaMapping(IReaderWriterLock.class),"newreaderwriterlock","new IReaderWriterLock($)",ExprType.rawboolean).range(0,1).call().rt("runtime.concurrent.IReaderWriterLock")
        );
    }
