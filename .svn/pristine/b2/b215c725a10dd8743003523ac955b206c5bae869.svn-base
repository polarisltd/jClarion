   ...
   INCLUDE('abreport.inc'),ONCE
                     ...
                     MAP
                       INCLUDE('COOKB010.INC'),ONCE        !Local module procedure declarations
                     END


PrintRIM:primarykey PROCEDURE                         !Generated from procedure template - Report
...
report               REPORT,AT(1000,1540,6000,7460),PRE(RPT),FONT('Arial',10,,),THOUS
                       HEADER,AT(1000,1000,6000,540)
                         STRING('Print the rimap File by RIM:primarykey'),AT(0,20,6000,220),CENTER,FONT(,,,FONT:bold)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintRIM:primarykey')
...
!  SELF.setICON()
  ...
  ThisReport.Init(Process:View, Relate:rimap, ?Progress:PctText, Progress:Thermometer, ProgressMgr, RIM:id)
  ThisReport.AddSortOrder(RIM:primarykey)
