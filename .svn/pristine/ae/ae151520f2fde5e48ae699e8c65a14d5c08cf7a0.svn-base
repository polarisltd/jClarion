...
/*
    ...
    */
    ...
    public void addShape(GeneralPath addShape) throws SVGException
    {
        ...
        if (getStyle(sty.setName("letter-spacing"))) letterSpacing = sty.getFloatValueWithUnits();
        else letterSpacing = 0f;
        
        if (getStyle(sty.setName("font-weight"))) {
        	String weight=sty.getStringValue();;
        ...
        if (font == null)
        {
            addShapeSysFont(addShape, font, fontFamily, fontSize,letterSpacing,bold);
            return;
        }
    ...
    private void addShapeSysFont(GeneralPath addShape, Font font, String fontFamily, float fontSize,float letterSpacing,boolean bold)
    {
        java.awt.Font sysFont = new java.awt.Font(fontFamily, bold ? java.awt.Font.BOLD : java.awt.Font.PLAIN, (int)fontSize);
