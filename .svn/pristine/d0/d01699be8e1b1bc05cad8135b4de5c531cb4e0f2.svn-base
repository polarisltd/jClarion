...
public abstract class AbstractControl extends PropertyObject implements RemoteWidget
{
    ...
    public void notifyActualSize()
    {
    	...
    	GUIModel.getServer().send(this,ACTUAL_SIZE_NOTIFY,
    		getWindowOwner().widthPixelsToDialog(c.getWidth()- (i == null ? 0 : i.left + i.right)),
    		getWindowOwner().heightPixelsToDialog(c.getHeight() - (i == null ? 0 : i.top + i.bottom)));
    }
    		...
    		case TOGGLE_MODE: {
                ...
                if (refocus) {
                    ...
                    if (c!=null) {
                        ...
                        if (cftp.accept(f,null)) return null;
