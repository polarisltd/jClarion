...
public class PrototypeParserTest  extends TestCase {
    ...
    public void testMapProc()
    {
        ...
        ClarionCompiler cc = new ClarionCompiler();
        Parser p = new Parser(cc,l);
        assertTrue(p.prototype.getMap());
        assertEquals("junk",l.next().value);
        
        List<Procedure> procs= cc.getScope().getProcedures();
    ...
    public void testMapProcWithModules()
    {
        ...
        ClarionCompiler cc = new ClarionCompiler();
        cc.setSource(new MemoryLexerSource());
        Parser p = new Parser(cc,l);
        assertTrue(p.prototype.getMap());
        assertEquals("junk",l.next().value);
        ...
        assertEquals(1,cc.main().getModules().size());
        
        procs = cc.main().getModules().iterator().next().getProcedures();
        assertEquals(1,procs.size());
