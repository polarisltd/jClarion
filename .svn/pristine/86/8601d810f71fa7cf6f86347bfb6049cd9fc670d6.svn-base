...
public class PatternRewriterTest extends TestCase {
    ...
    public void testTypicalRewrite()
    {
        ...
        assertEquals("setAt(1+3,Clarion.newNumber(\"hello\").intValue(),Clarion.newDecimal(\"27.2\").intValue(),5)",r.rewrite(in).toJavaString());
    }
    ...
    public void testRewriteWithNulls()
    {
        ...
        assertEquals("setAt(1+3,Clarion.newNumber(\"hello\").intValue(),null,null)",r.rewrite(in).toJavaString());
    }
