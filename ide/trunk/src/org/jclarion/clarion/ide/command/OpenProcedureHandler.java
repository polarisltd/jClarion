...
public class OpenProcedureHandler extends AbstractHandler
{
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException 
	{
		...
		if (selection instanceof IStructuredSelection && !selection.isEmpty()) {
			...
			try {
				workbenchWindow.getActivePage().openEditor(new ClarionProcedureInput(model),"org.jclarion.clarion.ide.editor.ClarionProcedureEditor");
