...
public class OpenModuleSourceHandler extends AbstractHandler
{
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException 
	{
		...
		if (selection instanceof IStructuredSelection && !selection.isEmpty()) {
			...
			try {
				workbenchWindow.getActivePage().openEditor(new EmbeditorInput(model,true,false),"org.jclarion.clarion.ide.editor.ClarionIncEditor");
