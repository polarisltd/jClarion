...
public class Zoompresets extends ClarionGroup
{
	...
	public ClarionNumber _anon_3=Clarion.newNumber(Constants.NOZOOM).setEncoding(ClarionNumber.SHORT);
	...
	public ClarionNumber _anon_6=Clarion.newNumber(Constants.PAGEWIDTH).setEncoding(ClarionNumber.SHORT);
