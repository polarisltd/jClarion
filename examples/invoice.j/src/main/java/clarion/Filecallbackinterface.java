...
public abstract class Filecallbackinterface implements org.jclarion.clarion.hooks.Filecallbackinterface
{
	...
	public abstract ClarionNumber functionCalled(ClarionNumber opCode,Params parameters,ClarionString fileErrCode,ClarionString fileErrMsg);
	public abstract ClarionNumber functionDone(ClarionNumber opCode,Params parameters,ClarionString fileErrCode,ClarionString fileErrMsg);
}
