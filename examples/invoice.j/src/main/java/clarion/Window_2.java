...
public class Window_2 extends ClarionWindow
{
	...
	public int _help=0;
	public int _close=0;
	public Window_2(QueueReltree queueRelTree)
	{
		this.setText("Browse Customers Orders In Tree View").setAt(null,null,312,193).setFont("MS Sans Serif",8,Color.BLACK,Font.BOLD,null).setCenter().setImmediate().setIcon("NOTE14.ICO").setHelp("~BrowseCustomersOrdersInTreeView").setSystem().setGray().setResize().setMDI();
		...
		_C2.setFlat().setIcon("Insert.ico").setText("Insert").setAt(4,177,48,15).setSkip().setLeft(null).setFont(null,null,Color.GREEN,Font.BOLD,null).setTip("Insert a record");
		this._insert=this.register(_C2,"browseallorders.window.insert");
		this.add(_C2);
		ButtonControl _C3=new ButtonControl();
		_C3.setFlat().setIcon("Edit.ico").setText("Change").setAt(55,177,48,15).setSkip().setLeft(null).setFont(null,8,Color.GREEN,Font.BOLD,null).setTip("Edit a record");
		this._change=this.register(_C3,"browseallorders.window.change");
		this.add(_C3);
		ButtonControl _C4=new ButtonControl();
		_C4.setFlat().setIcon("Delete.ico").setText("Delete").setAt(106,177,48,15).setSkip().setLeft(null).setFont(null,null,Color.GREEN,Font.BOLD,null).setTip("Delete a record");
		...
		_C6.setFlat().setIcon(Icon.NONE).setText("&Expand All").setAt(161,177,55,15).setSkip().setFont(null,null,Color.NAVY,Font.BOLD,null).setTip("Expand All Branches");
		this._expand=this.register(_C6,"browseallorders.window.expand");
		this.add(_C6);
		ButtonControl _C7=new ButtonControl();
		_C7.setFlat().setIcon(Icon.NONE).setText("Co&ntract All").setAt(218,177,55,15).setSkip().setFont(null,null,Color.NAVY,Font.BOLD,null).setTip("Contract All Branches");
		...
		_C9.setFlat().setIcon("EXITS.ICO").setAt(290,177,19,15).setSkip().setTip("Exits Browse");
