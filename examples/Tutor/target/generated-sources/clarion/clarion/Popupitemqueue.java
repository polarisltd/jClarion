...
public class Popupitemqueue extends ClarionQueue
{
	...
	public ClarionNumber depth=Clarion.newNumber().setEncoding(ClarionNumber.UNSIGNED);
	public ClarionNumber event=Clarion.newNumber().setEncoding(ClarionNumber.UNSIGNED);
