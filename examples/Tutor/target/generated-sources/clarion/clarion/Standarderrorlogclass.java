...
public class Standarderrorlogclass extends org.jclarion.clarion.AbstractThreaded
{
	...
	protected void lock(Standarderrorlogclass base,Thread thread)
	{
		super.lock(base,thread);
		this.usage=(ClarionNumber)this.usage.getLockedObject(thread);
	}
	public Object getLockedObject(Thread thread)
	{
		Standarderrorlogclass result=new Standarderrorlogclass();
