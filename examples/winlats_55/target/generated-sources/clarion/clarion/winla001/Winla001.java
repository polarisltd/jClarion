...
import clarion.winla002.Winla002;
	...
	public static void main()
	{
		...
		try {
			...
			if (Main.global.db_gads.compareTo(2013)>0) {
				...
				System.out.println("GETVAL_K "+Main.val_uzsk.toString());
			...
			while (Clarion.getWindowTarget().accept()) {
				...
				}
				{
					...
					if (!case_2_break && case_2==appframe._fourfaili9izzinasnofailiem2bankusarakstsplans) {
						{
						CRun.start(new Runnable() { public void run() { Winla002.f_bankasreport(); } } ).getId();
						}
						case_2_break=true;
					}
