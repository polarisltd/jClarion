...
OpenMode          BYTE
  ...
  OF InvalidFileErr                               !Invalid Record Declaration
    ...
    !  OPEN(FILE,42h)    !LAI UZZINÂTU TÂ DRAÒÍA VÂRDU
    !  IF ERROR() THEN STOP('OPEN:'&ERROR()).
      KLUDA(0,'Mainîta struktûra failam : '&NAME(FILE))
    !  F_TEKSTS[1]='DUMMY.TPS'
    !  F_TEKSTS[2]=NAME(FILE)
    !  CLOSE(FILE)
    !  REMOVE(FILE)
    !!  IF ~CopyFileA(F_TEKSTS[1],F_TEKSTS[2],0)  !VAJADZÎGI 2 CSTRINGI
...
!|
      ...
      IF instring('SYSTEM.TPS',name(file),1)
         ...
         IF ERROR()
            ...
            ELSIF INRANGE(JOB_NR,81,95)
               SYS:AVOTS='Pamatlîdzekïi '&LOC_NR
      ...
      IF instring('TEK_K.TPS',name(file),1)
         IF RECORDS(FILE)=0
            clear(TEK:record)
            TEK:INI='Pelna un p'
            TEK:TEKSTS='Peïòa un peïòas nodoklis'
            TEK:TIPS='A'
            TEK:ATT_DOK=''
            TEK:D_K1='K'
            TEK:D_K2='K'
            ...
            clear(TEK:record)
            TEK:INI='RV:Program'
            TEK:TEKSTS='RV:Programmatûra WinLats'
            TEK:TIPS='A'
            TEK:ATT_DOK='6'
            TEK:D_K1='K'
            TEK:D_K2='D'
      ...
      IF instring('ATL_K.TPS',name(file),1)
         IF RECORDS(FILE)=0
            ...
            ATL:U_NR=101
            ATL:HIDDEN=0
            ATL:KOMENTARS='Atlaiþu diena(atlaides visiem)'
            ADD(FILE)
         .
      .
  ...
  !          GG:SATURS='SALDO UZ '&format(GG:DATUMS,@d5)
      ...
      IF INSTRING('DAIEV.TPS',name(file),1)
         IF RECORDS(FILE)=0
            ...
            DAI:VIDYN='Y'
            DAI:KODS=840
            DAI:NOSAUKUMS='Atvaïinâjums tekoðajâ mçnesî'
            ADD(FILE)
            DAI:KODS=841
            DAI:NOSAUKUMS='Atvaïinâjums nâkoðajâ mçnesî'
            ADD(FILE)
            DAI:KODS=842
            DAI:NOSAUKUMS='Atvaïinâjums aiznâkoðajâ mçnesî'
            ADD(FILE)
            DAI:KODS=850
            DAI:NOSAUKUMS='Slimîbas lapa ðajâ mçnesî'
            DAI:T='8'
            ADD(FILE)
            DAI:KODS=851
            DAI:NOSAUKUMS='Slimîbas lapa pagâjuðajâ mçnesî'
            ADD(FILE)
            DAI:KODS=852
            DAI:NOSAUKUMS='Slimîbas lapa nâkoðajâ mçnesî'
            ADD(FILE)
            DAI:KODS=901
            DAI:NOSAUKUMS='Ienâkuma nodokïa pamatlikme'
            DAI:T='4'
            ADD(FILE)
            DAI:KODS=902
            DAI:NOSAUKUMS='Ienâkuma nodokïa papildlikme'
            ADD(FILE)
            DAI:KODS=903
            DAI:NOSAUKUMS='Darba òçmçja sociâlais nodoklis'
            DAI:T='5'
            ADD(FILE)
            DAI:KODS=904
            ...
            ADD(FILE)
            DAI:KODS=905
            DAI:NOSAUKUMS='Pârmaksa/parâds'
            DAI:F='SYS'
            DAI:T='1'
            ADD(FILE)
            DAI:KODS=906
            DAI:NOSAUKUMS='Ienâkuma nod. par pagâjuðo mçnesi'
            DAI:T='4'
            ADD(FILE)
            DAI:KODS=907
            DAI:NOSAUKUMS='Ienâkuma nod. par aizpagâjuðo mçnesi'
            ADD(FILE)
            DAI:KODS=908
            DAI:NOSAUKUMS='Ienâkuma nod. par nâkoðo mçnesi'
            ADD(FILE)
            DAI:KODS=909
            DAI:NOSAUKUMS='Ienâkuma nod. par aiznâkoðo mçnesi'
            ADD(FILE)
            DAI:KODS=910
            DAI:NOSAUKUMS='Darba òçmçja soc. n. par nâkoðo mçnesi'
            DAI:T='5'
            ADD(FILE)
            DAI:KODS=911
            DAI:NOSAUKUMS='Darba òçm. soc. n. par aiznâkoðo mçn.'
            ADD(FILE)
         .
      .
         ...
         IF RECORDS(FILE)=0
            ...
            LOOP N#=1 TO 28
               ...
               ELSIF INRANGE(N#,26,28)
                  PAR:TIPS  ='R'
                  PAR:NOS_S='Raþoðana '&FORMAT(N#,@N2)
                  PAR:NOS_P='Raþoðana '&FORMAT(N#,@N2)
                  PAR:NOS_A='RAZOS'
                  ADD(FILE)
               .
            .
            ...
            PAR:ADRESE='Vaidavas 3a - 17, Rîga, LV-1084'
      ...
      IF instring('ADR_K.TPS',name(file),1)
         IF RECORDS(FILE)=0
            ...
            ADR:ADR_NR = 1
            ADR:TIPS  ='P'
            ADR:ADRESE='Vaidavas 3a - 17, Rîga, LV-1084'
            ADD(FILE)
         .
      .
