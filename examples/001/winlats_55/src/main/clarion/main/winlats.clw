...
KOPS::KR_SUMMA             DECIMAL(11,2),DIM(12,25)
 ...
 SKIP000030   
  ...
  OMIT('SKIP000040')
     ...
     END
     MODULE('winla234.clw')
       GETBIL_FIFO(BYTE,*DECIMAL,*DECIMAL,DECIMAL),BYTE    ! GETBIL_FIFO(BYTE,*DECIMAL,*DECIMAL,*DECIMAL[]),BYTE %%%%%%%
       IZZFILTbilform 
       SPZ_Invoice
     END
     MODULE('winla235.clw')
 ...
 SKIP000060
     ...
     END
      OMIT('SKIP_DLL')     
      MODULE('Kernel32.clw')
         sndPlaySoundA(CSTRING,UNSIGNED),BOOL
         CreateDirectoryA(CSTRING,SECURITY_ATTRIBUTES),BOOL
         MemoryRead(WORD,DWORD,LPVOID,DWORD),DWORD
         CopyFileA(CSTRING,CSTRING,BOOL),BOOL
         MoveFileA(CSTRING,CSTRING),BOOL
         GetVersion(),DWORD
     ...
     !    CloseHandle(HANDLE),BOOL,PASCAL
      ...
      MODULE('GA1.clw')
           LabelConfig(),SHORT,C,RAW,DLL
           LabelNomenklatura(*LPCSTR,*LPCSTR,*LPCSTR,*LPCSTR,*LPCSTR,*LPCSTR,*LPCSTR,*LPCSTR,SHORT,SHORT),SHORT,C,RAW,DLL
           LabelPartneris(*LPCSTR,*LPCSTR,*LPCSTR,*LPCSTR,SHORT),SHORT,C,RAW,DLL
      END
     ! MODULE('TRACE.DLL')
...
lAdjFDSetting        LONG
KLUDAS                  FILE,DRIVER('ODBC'),NAME('kludas'),PRE(KLU),CREATE,BINDABLE,THREAD  ! ,RECLAIM not supported!   KLUDAS                  FILE,DRIVER('ODBC'),RECLAIM,NAME('\winlats\bin\kludas'),PRE(KLU),CREATE,BINDABLE,THREAD %%%%%%%
...
PAR_E                   FILE,DRIVER('ODBC'),PRE(EMA),NAME('par_e'),CREATE,BINDABLE,THREAD ! RECLAIM is not supportedPAR_E                   FILE,DRIVER('ODBC'),RECLAIM,PRE(EMA),CREATE,BINDABLE,THREAD %%%%%
...
AMATI                   FILE,DRIVER('ODBC'),PRE(AMS),NAME('amati'),CREATE,BINDABLE,THREAD
...
!PAR_A                   FILE,DRIVER('ODBC'),RECLAIM,PRE(ADR),CREATE,BINDABLE,THREAD ! RECLAIM not supported %%%%%%%%%%%
PAR_A                   FILE,DRIVER('ODBC'),PRE(ADR),NAME('par_a'),CREATE,BINDABLE,THREAD
...
OUTFILE                 FILE,DRIVER('ASCII'),NAME(ASCIIFILENAME),PRE(OUT),CREATE,BINDABLE,THREAD ! OEM, %%%%%%%%%%%%
Record                   RECORD,PRE()
LINE                        STRING(500)
                         END
                       END
...
!GRAFIKS                 FILE,DRIVER('ODBC'),RECLAIM,PRE(GRA),CREATE,BINDABLE,THREAD ! RECLAIM not supported %%%%%%%%%%%
GRAFIKS                 FILE,DRIVER('ODBC'),PRE(GRA),NAME('grafiks'),CREATE,BINDABLE,THREAD
...
! KON_K                   FILE,DRIVER('ODBC'),RECLAIM,NAME('KON_K'),PRE(KON),CREATE,BINDABLE,THREAD  ! RECLAIM not supported %%%%%%%%%%%
KON_K                   FILE,DRIVER('ODBC'),NAME('KON_K'),PRE(KON),CREATE,BINDABLE,THREAD
...
!ATL_S                   FILE,DRIVER('ODBC'),RECLAIM,NAME('ATL_S'),PRE(ATS),CREATE,BINDABLE,THREAD  ! RECLAIM not supported %%%%%%%%%%%
ATL_S                   FILE,DRIVER('ODBC'),NAME('ATL_S'),PRE(ATS),CREATE,BINDABLE,THREAD
...
!BANKAS_K                FILE,DRIVER('ODBC'),RECLAIM,NAME('BANKAS_K'),PRE(BAN),CREATE,BINDABLE,THREAD ! RECLAIM not supported %%%%%%%%%%%
BANKAS_K                FILE,DRIVER('ODBC'),NAME('BANKAS_K'),PRE(BAN),CREATE,BINDABLE,THREAD
KOD_KEY                  KEY(BAN:KODS),PRIMARY
...
!GLOBAL                  FILE,DRIVER('ODBC'),RECLAIM,NAME('GLOBAL'),PRE(GL),CREATE,BINDABLE,THREAD  ! RECLAIM not supported %%%%%%%%%%%
GLOBAL                  FILE,DRIVER('ODBC'),NAME('GLOBAL'),PRE(GL),CREATE,BINDABLE,THREAD
PKGlobal                 KEY(ID),NAME('PK_GLOBAL'),PRIMARY
Record                   RECORD,PRE()
ID                                LONG,AUTO
REG_NR                      STRING(11)
VID_NR                      STRING(13)
...
AUTOTEX                 FILE,DRIVER('ODBC'),NAME(ATEXNAME),PRE(APX),CREATE,BINDABLE,THREAD
...
!AUTOAPK1                FILE,DRIVER('ODBC'),RECLAIM,NAME(FILENAME1),PRE(APK1),CREATE,BINDABLE,THREAD ! RECLAIM not supported %%%%%%%%%%%
AUTOAPK1                FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(APK1),CREATE,BINDABLE,THREAD
...
KURSI_K                 FILE,DRIVER('ODBC'),NAME('KURSI_K'),PRE(KUR),CREATE,BINDABLE,THREAD  ! ,RECLAIM %%%%%%%%%
...
AUTODARBI1              FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(APD1),CREATE,BINDABLE,THREAD
...
AUTODARBI               FILE,DRIVER('ODBC'),NAME(ADARBINAME),PRE(APD),CREATE,BINDABLE,THREAD
...
VAL_K                   FILE,DRIVER('ODBC'),NAME('VAL_K'),PRE(VAL),CREATE,BINDABLE,THREAD ! ,RECLAIM  %%%%%%%%%%%%%%
...
GG                      FILE,DRIVER('ODBC'),NAME(GGNAME),PRE(GG),CREATE,BINDABLE,THREAD ! RECLAIM, %%%%%%%%%%%%%%%%
...
AU_TEX                  FILE,DRIVER('ODBC'),NAME(AUBTEXNAME),PRE(AUX),CREATE,BINDABLE,THREAD
...
G1                      FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(G1),CREATE,BINDABLE,THREAD  ! ,RECLAIM %%%%%%%%%%%%%%%%%
...
VESTURE                 FILE,DRIVER('ODBC'),NAME('VESTURE'),PRE(VES),CREATE,BINDABLE,THREAD  ! ,RECLAIM %%%%%%%%%%%%%%%%
...
GGK                     FILE,DRIVER('ODBC'),NAME(GGKNAME),PRE(GGK),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%%%%%%
...
GK1                     FILE,DRIVER('ODBC'),NAME(FILENAME2),PRE(GK1),CREATE,BINDABLE,THREAD ! RECLAIM, %%%%%%%%%%%%%%%
...
PAROLES                 FILE,DRIVER('ODBC'),OWNER('MARIS'),NAME('PAROLES'),PRE(SEC),CREATE,BINDABLE,THREAD ! RECLAIM,,ENCRYPT %%%%%
...
SYSTEM                  FILE,DRIVER('ODBC'),NAME('SYSTEM'),PRE(SYS),CREATE,BINDABLE,THREAD   ! ,RECLAIM %%%%%%%%%%%%%
...
TEK_K                   FILE,DRIVER('ODBC'),NAME('TEK_K'),PRE(TEK),CREATE,BINDABLE,THREAD  ! ,RECLAIM %%%%%%%%%%%%%%%%%%%
...
NOLIK                   FILE,DRIVER('ODBC'),NAME(NOLIKNAME),PRE(NOL),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%
...
NOL_KOPS                FILE,DRIVER('ODBC'),NAME('NOL_KOPS'),PRE(KOPS),CREATE,BINDABLE,THREAD ! ,RECLAIM
...
NOL_FIFO                FILE,DRIVER('ODBC'),NAME('NOL_FIFO'),PRE(FIFO),CREATE,BINDABLE,THREAD
...
PAVAD                   FILE,DRIVER('ODBC'),NAME(PAVADNAME),PRE(PAV),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%
...
PAMKAT                  FILE,DRIVER('ODBC'),NAME(PAMKATNAME),PRE(PAK),CREATE,BINDABLE,THREAD
Record                   RECORD,PRE()
...
PAR_K                   FILE,DRIVER('ODBC'),NAME(PARNAME),PRE(PAR),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%%
...
NOM_K                   FILE,DRIVER('ODBC'),NAME(NOMNAME),PRE(NOM),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%
...
MER_K                   FILE,DRIVER('ODBC'),NAME('MER_K'),PRE(MER),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%%%%
...
ATL_K                   FILE,DRIVER('ODBC'),NAME('ATL_K'),PRE(ATL),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%
...
KOMPLEKT                FILE,DRIVER('ODBC'),NAME('KOMPLEKT'),PRE(KOM),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%
...
FPPAVAD                 FILE,DRIVER('ODBC'),NAME(FPPAVADNAME),PRE(FPP),CREATE,BINDABLE,THREAD
...
FPNOLIK                 FILE,DRIVER('ODBC'),NAME(FPNOLIKNAME),PRE(FPN),CREATE,BINDABLE,THREAD
...
AU_BILDE                FILE,DRIVER('ODBC'),NAME(AUBNAME),PRE(AUB),CREATE,BINDABLE,THREAD
...
PAMAM                   FILE,DRIVER('ODBC'),NAME(PAMAMNAME),PRE(AMO),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%
...
PAR_K1                  FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(PAR1),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%
...
NOLI1                   FILE,DRIVER('ODBC'),NAME(FILENAME2),PRE(NO1),CREATE,BINDABLE,THREAD ! ,RECLAIM
...
NOLPAS                  FILE,DRIVER('ODBC'),NAME('NOLPAS'),PRE(NOS),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%%%%%
...
ALGAS                   FILE,DRIVER('ODBC'),NAME(ALGASNAME),PRE(ALG),CREATE,BINDABLE,THREAD ! ,RECLAIMb%%%%%%%%%%
...
PAR_Z                   FILE,DRIVER('ODBC'),PRE(ATZ),NAME('par_z'),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%%%
...
DAIEV                   FILE,DRIVER('ODBC'),NAME('DAIEV'),PRE(DAI),CREATE,BINDABLE,THREAD ! ,RECLAIM %%%%%%%%%
...
KADRI                   FILE,DRIVER('ODBC'),NAME('KADRI'),PRE(KAD),CREATE,BINDABLE,THREAD  ! ,RECLAIM %%%%%%%%%%%%%
...
NOM_A                   FILE,DRIVER('ODBC'),NAME('NOM_A'),PRE(NOA),CREATE,BINDABLE,THREAD
...
NOL_STAT                FILE,DRIVER('ODBC'),NAME('NOL_STAT'),PRE(STAT),CREATE,BINDABLE,THREAD
...
NOM_K1                  FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(NOM1),CREATE,BINDABLE,THREAD
...
PERNOS                  FILE,DRIVER('ODBC'),NAME('PERNOS'),PRE(PER),CREATE,BINDABLE,THREAD
...
TEKSTI                  FILE,DRIVER('ODBC'),NAME(TEXNAME),PRE(TEX),CREATE,BINDABLE,THREAD
...
AUTO                    FILE,DRIVER('ODBC'),NAME('AUTO'),PRE(AUT),CREATE,BINDABLE,THREAD
...
KAT_K                   FILE,DRIVER('ODBC'),NAME('KAT_K'),PRE(KAT),CREATE,BINDABLE,THREAD
...
PAMAT                   FILE,DRIVER('ODBC'),NAME(PAMATNAME),PRE(PAM),CREATE,BINDABLE,THREAD
...
ALGPA                   FILE,DRIVER('ODBC'),NAME(ALPANAME),PRE(ALP),CREATE,BINDABLE,THREAD
...
NOM_C                   FILE,DRIVER('ODBC'),NAME('NOM_C'),PRE(NOC),CREATE,BINDABLE,THREAD
...
CAL                     FILE,DRIVER('ODBC'),NAME('CAL'),PRE(CAL),CREATE,BINDABLE,THREAD
...
G2                      FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(G2),CREATE,BINDABLE,THREAD ! ,OEM %%%%%%%%%%
...
PAVA1                   FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(PA1),CREATE,BINDABLE,THREAD
...
PAVPAS                  FILE,DRIVER('ODBC'),NAME('PAVPAS'),PRE(PAS),CREATE,BINDABLE,THREAD
...
GK2                     FILE,DRIVER('ODBC'),NAME(FILENAME2),PRE(GK2),CREATE,BINDABLE,THREAD ! ,OEM %%%%%%%%%%%%%
...
B_PAVAD                 FILE,DRIVER('ODBC'),NAME(B_PAVADNAME),PRE(BPA),CREATE,BINDABLE,THREAD
Record                   RECORD,PRE()
DATUMS                      DATE
D_K                         STRING(1)
DOK_SENR                    STRING(14)
...
GRUPA1                  FILE,DRIVER('ODBC'),NAME('GRUPA1'),PRE(GR1),CREATE,BINDABLE,THREAD
...
GRUPA2                  FILE,DRIVER('ODBC'),NAME('GRUPA2'),PRE(GR2),CREATE,BINDABLE,THREAD
...
PROJEKTI                FILE,DRIVER('ODBC'),NAME('PROJEKTI'),PRE(PRO),CREATE,BINDABLE,THREAD
...
KOIVUNEN                FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(KOI),CREATE,BINDABLE,THREAD
Record                   RECORD,PRE()
PIEG                        STRING(3)
PIEG_KODS                   STRING(22)
...
CENUVEST                FILE,DRIVER('ODBC'),NAME('CENUVEST'),PRE(CEN),CREATE,BINDABLE,THREAD
...
CONFIG                  FILE,DRIVER('ODBC'),NAME('CONFIG'),PRE(CON),CREATE,BINDABLE,THREAD
...
PAR_L                   FILE,DRIVER('ODBC'),NAME('par_l'),PRE(PAL),CREATE,BINDABLE,THREAD
...
NOM_N                   FILE,DRIVER('ODBC'),NAME('NOM_N'),PRE(NON),CREATE,BINDABLE,THREAD
...
AUTOAPK                 FILE,DRIVER('ODBC'),NAME(AAPKNAME),PRE(APK),CREATE,BINDABLE,THREAD
...
AUTOMARKAS              FILE,DRIVER('ODBC'),NAME('AUTOMARK'),PRE(AMA),CREATE,BINDABLE,THREAD
...
CROSSREF                FILE,DRIVER('ODBC'),PRE(CRO),NAME('crossref'),CREATE,BINDABLE,THREAD
...
TEK_SER                 FILE,DRIVER('ODBC'),PRE(TES),CREATE,NAME('tek_ser'),BINDABLE,THREAD
...
NOM_P                   FILE,DRIVER('ODBC'),PRE(NOP),NAME('nom_p'),CREATE,BINDABLE,THREAD
...
NODALAS                 FILE,DRIVER('ODBC'),PRE(NOD),NAME('nodalas'),CREATE,BINDABLE,THREAD
...
INVENT                  FILE,DRIVER('ODBC'),NAME(INVNAME),PRE(INV),CREATE,BINDABLE,THREAD
...
TEKSTI1                 FILE,DRIVER('ODBC'),NAME(FILENAME1),PRE(TEX1),CREATE,BINDABLE,THREAD
...
KAD_RIK                 FILE,DRIVER('ODBC'),PRE(RIK),NAME('kad_rik'),CREATE,BINDABLE,THREAD
...
AUTOKRA                 FILE,DRIVER('ODBC'),PRE(KRA),NAME('autokra'),CREATE,BINDABLE,THREAD
...
EIROKODI                FILE,DRIVER('ODBC'),NAME('EIROKODI'),PRE(EIR),CREATE,BINDABLE,THREAD
...
KON_R                   FILE,DRIVER('ODBC'),NAME(KONRNAME),PRE(KONR),CREATE,BINDABLE,THREAD
...
PROJ_P                  FILE,DRIVER('ODBC'),PRE(PRP),CREATE,NAME('proj_p'),BINDABLE,THREAD
...
ARM_K                   FILE,DRIVER('ODBC'),PRE(ARM),CREATE,NAME('arm_k'),BINDABLE,THREAD
...
PAM_P                   FILE,DRIVER('ODBC'),PRE(PAP),NAME('pam_p'),CREATE,BINDABLE,THREAD
