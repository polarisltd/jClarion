    ...
    OF ?OkButton
      ...
      OF EVENT:Accepted
        ...
        !   LabelConfig(),BOOL,PASCAL,RAW,DLL
            ...
            I#=LabelNomenklatura(NOM:SKODS,NOM:SNOMENKLAT,NOM:SKATALOGA_NR,SCENA,NOM:SNOSAUKUMS,SPLAUKTS,SRAZKODS,SDATUMS,SKAITS,0)
            IF I#
               EXECUTE I#
                  KLUDA(0,'LP: Nevar atvçrt portu')
                  KLUDA(0,'LP: Etiíeðu skaits mazâks par 1')
                  KLUDA(0,'LP: Nezinâms valodas tips -> INI -> [Printer] Type=')
                  KLUDA(0,'LP: Nevar atrast INI failâ [Printer] Port=')
                  KLUDA(0,'LP: Nevar atvçrt konfigurâcijas failu [Printer] Config=')
               .
            .
