...
public class Reportmanager_1 extends Windowmanager
{
	...
	public Printpreviewclass_1 preview=null;
	public Previewqueue previewqueue=null;
	public Processclass_1 process=null;
	...
	public void init(Processclass_1 p0,ClarionReport p1)
	{
		init(p0,p1,(Printpreviewclass_1)null);
	}
	public void init(Processclass_1 p0)
	{
		init(p0,(ClarionReport)null);
	}
	public void init(Processclass_1 pc,ClarionReport r,Printpreviewclass_1 pv)
	{
		throw new RuntimeException("Procedure/Method not defined");
	}
