...
public class Quickwindow_1 extends ClarionWindow
{
	...
	{
		this.setText("Browse Products ").setAt(null,null,403,180).setFont("MS Sans Serif",8,null,null,null).setImmediate().setHVScroll().setIcon("FLOW04.ICO").setHelp("~BrowseProducts").setSystem().setGray().setResize().setMDI();
		...
		_C3.setText("Filter Locator: Description").setAt(9,15,103,11).setFont("MS Sans Serif",8,null,Font.BOLD,null);
		...
		this.add(_C12);
		PanelControl _C13=new PanelControl();
		_C13.setAt(266,18,127,137).setBevel(2,-1,null);
		this._panel1=this.register(_C13,"browseproducts.quickwindow.panel1");
		this.add(_C13);
		ImageControl _C14=new ImageControl();
		_C14.setAt(267,19,123,134);
		this._image1=this.register(_C14,"browseproducts.quickwindow.image1");
		this.add(_C14);
		ButtonControl _C15=new ButtonControl();
		_C15.setText("&Insert").setAt(145,125,28,12).setHidden();
		this._insert=this.register(_C15,"browseproducts.quickwindow.insert");
		this.add(_C15);
		ButtonControl _C16=new ButtonControl();
		_C16.setText("&Change").setAt(187,125,28,12).setHidden();
		this._change=this.register(_C16,"browseproducts.quickwindow.change");
		this.add(_C16);
		ButtonControl _C17=new ButtonControl();
		_C17.setText("&Delete").setAt(21,118,28,12).setHidden();
		this._delete=this.register(_C17,"browseproducts.quickwindow.delete");
		this.add(_C17);
		ButtonControl _C18=new ButtonControl();
		_C18.setIcon(Icon.HELP).setAt(229,124,13,12).setHidden().setTip("Get Help").setStandard(Std.HELP);
		this._help=this.register(_C18,"browseproducts.quickwindow.help");
		this.add(_C18);
		ButtonControl _C19=new ButtonControl();
		_C19.setIcon("EXITS.ICO").setFlat().setAt(371,157,20,17).setSkip().setMsg("Exit Browse").setTip("Exit Browse");
		this._close=this.register(_C19,"browseproducts.quickwindow.close");
		this.add(_C19);
	}
}
