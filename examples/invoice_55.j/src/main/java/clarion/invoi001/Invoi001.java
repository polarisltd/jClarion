...
public class Invoi001
{
	...
	public static void browseallorders()
	{
		...
		Rel1Toolbar rel1Toolbar=new Rel1Toolbar(queueReltree,window,rel1Loadedqueue,rel1Savelevel,rel1Currentchoice,displaystring,rel1Loadall,rel1Action,rel1Newitemlevel,rel1Newitemposition,thiswindow); // moved down %%%%%
