...
public class Quickwindow_3 extends ClarionWindow
{
	...
	{
		this.setText("Update Detail").setAt(null,null,193,116).setFont("MS Sans Serif",8,null,null,null).setImmediate().setIcon("NOTE14.ICO").setHelp("~UpdateDetail").setSystem().setGray().setResize().setMDI();
		this.setId("updatedetail.quickwindow");
		SheetControl _C1=new SheetControl();
		_C1.setWizard().setAt(3,2,187,92);
		...
		_C21.setIcon("DISK12.ICO").setDefault().setFlat().setAt(53,95,22,20).setTip("Save record and Exit");
		this._ok=this.register(_C21,"updatedetail.quickwindow.ok");
		this.add(_C21);
		ButtonControl _C22=new ButtonControl();
		_C22.setIcon(Icon.HELP).setFlat().setAt(86,100,13,12).setHidden().setTip("Get Help").setStandard(Std.HELP);
		this._help=this.register(_C22,"updatedetail.quickwindow.help");
		this.add(_C22);
		ButtonControl _C23=new ButtonControl();
		_C23.setIcon(Icon.CROSS).setFlat().setAt(110,95,22,20).setMsg("Cancel changes and Exit").setTip("Cancel changes and Exit");
