...
public class Quickwindow_2 extends ClarionWindow
{
	...
	{
		this.setText("Select a Product").setAt(null,null,236,134).setFont("MS Sans Serif",8,null,null,null).setImmediate().setIcon("ORCHID.ICO").setHelp("~SelectaProduct").setSystem().setGray().setResize().setMDI();
		...
		_C5.setText("&Select").setAt(41,19,25,13).setHidden().setFont("MS Serif",8,null,null,null).setMsg("Select a Product from list").setTip("Select a Product from list");
		this._select_2=this.register(_C5,"selectproducts.quickwindow.select:2");
		this.add(_C5);
		StringControl _C6=new StringControl();
		_C6.setText("Locator:").setAt(7,114,39,12).setTransparent().setFont("MS Serif",10,null,Font.BOLD,null);
		...
		_C9.setIcon("EXITS.ICO").setFlat().setAt(201,111,23,18).setSkip().setMsg("Exit Browse").setTip("Exit Browse and cancel selection");
