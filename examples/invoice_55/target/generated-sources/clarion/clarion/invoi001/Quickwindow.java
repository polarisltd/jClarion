...
public class Quickwindow extends ClarionWindow
{
	...
	{
		this.setText("Select a State").setAt(null,null,173,203).setFont("MS Sans Serif",8,null,null,null).setImmediate().setIcon("USA1.ICO").setHelp("~SelectaState").setSystem().setGray().setResize().setMDI();
		...
		_C11.setIcon("EXITS.ICO").setFlat().setAt(145,181,19,16).setTip("Cancel selection and exit browse");
