...
public class Report_5 extends ClarionReport
{
	...
	public Report_5(ClarionString lOCAddress,ClarionString locCsz)
	{
		...
		_C3.setText("Name:").setAt(1146,94,1844,167).setTransparent().setFont("MS Serif",10,Color.BLACK,Font.REGULAR,null);
		this.detail.add(_C3);
		...
		_C5.setText("Company:").setAt(1146,354,1844,167).setTransparent().setFont("MS Serif",10,Color.BLACK,Font.REGULAR,null);
		this.detail.add(_C5);
		...
		_C10.setText("City/State/Zip:").setAt(1146,875,1844,167).setTransparent().setFont("MS Serif",10,Color.BLACK,Font.REGULAR,null);
		...
		_C13.setText("Phone#/Extension:").setAt(1146,1135,1844,167).setTransparent().setFont("MS Serif",10,Color.BLACK,Font.REGULAR,null);
		...
		_C15.setPageNo().setPicture("@pPage <<<#p").setAt(5229,31,729,188).setFont("MS Serif",10,Color.BLACK,Font.REGULAR,null);
