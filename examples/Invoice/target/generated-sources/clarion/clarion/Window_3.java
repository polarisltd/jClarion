...
public class Window_3 extends ClarionWindow
{
	...
	public Window_3()
	{
		this.setAt(null,null,306,147).setFont("MS Sans Serif",8,Color.BLACK,Font.REGULAR,null).setColor(0x80ffff,null,null).setCenter().setGray().setNoFrame().setMDI();
		...
		_C6.setText("Alstroemeria.jpg").setAt(12,11,101,102);
		...
		_C8.setText("Revised using Clarion 6").setAt(11,124,284,12).setTransparent().setCenter(null).setFont("MS Sans Serif",10,null,null,null);
