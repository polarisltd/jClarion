...
public class Constants
{
	...
	public static final int REG_CLASSES_ROOT=(int)0x80000000l;
	public static final int REG_CURRENT_USER=(int)0x80000001l;
	public static final int REG_LOCAL_MACHINE=(int)0x80000002l;
	public static final int REG_USERS=(int)0x80000003l;
	public static final int REG_PERFORMANCE_DATA=(int)0x80000004l;
	public static final int REG_CURRENT_CONFIG=(int)0x80000005l;
	public static final int REG_DYN_DATA=(int)0x80000006l;
	...
	public static final int PROCESSRECORD=5;
	public static final int VIEWRECORD=6;
	public static final int SAVERECORD=7;
	...
	public static final int __CWIFACE_INC=1;
	public static final int __CWSYNCH_INT=1;
	public static final int ERROR_ALREADY_EXISTS=183;
	public static final int _POPUPPRESENT_=1;
	public static final int _UTILITIESPRESENT_=1;
	public static final int NVD_INI=0;
	public static final int NVD_REGISTRY=Constants.NVD_INI+1;
	public static final int NVD_TABLE=Constants.NVD_INI+2;
	...
	public static final int _FORMVCRPRESENT_=1;
	...
	public static final int KEYLENGTHERR=88;
	...
	public static final int STREAMERR=97;
	public static final int TRIGGERERR=100;
	...
	public static final int ERRCLARION=0;
	public static final int ERRFILE=Constants.ERRCLARION+1;
	...
	public static final int _RWENGINEDLLMODE=1;
	public static final int _RWENGINEDLLMODE_SET=1;
	public static final int _REPORTENGINEPRESENT_=1;
	public static final int WC_STANDARD=0;
	public static final int WC_FORMVCR=Constants.WC_STANDARD+1;
	public static final int TRACEFILES=0;
	public static final int __CWSYNCHC_INC=1;
	public static final int LINKASCIIDRIVER=0;
	...
	public static final int QBEUNKNOWN=0;
	public static final int QBEFORMBASED=Constants.QBEUNKNOWN+1;
	public static final int QBELISTBASED=Constants.QBEUNKNOWN+2;
	...
	public static final int _WMFPARSER_=1;
	public static final int _REPORTGENERATORINTERFACE_=Constants.TRUE;
	public static final int MAXATTRIBUTESIZE=2048;
	public static final int _REPORTATTRIBUTEMANAGERPRESENT_=1;
	public static final int _REPORTTARGETSELECTORCLASSPRESENT_=1;
	public static final int _BREAKMANAGERCLASSPRESENTE_=1;
	public static final int EBREAKTOTALCNT=1;
	public static final int EBREAKTOTALAVE=2;
	public static final int EBREAKTOTALSUM=3;
	...
	public static final int STANDARD_RIGHTS_READ=Constants.READ_CONTROL;
	public static final int STANDARD_RIGHTS_WRITE=Constants.READ_CONTROL;
	public static final int STANDARD_RIGHTS_EXECUTE=Constants.READ_CONTROL;
	public static final int STANDARD_RIGHTS_ALL=0x1f0000;
	public static final int SPECIFIC_RIGHTS_ALL=0xffff;
	public static final int GENERIC_READ=(int)0x80000000l;
	...
	public static final int INVALID_LONG_VALUE=(int)4294967295l;
	...
	public static final String DEFAULTINSERTTEXT="&Insert";
	public static final String DEFAULTCHANGETEXT="&Change";
	...
	public static final String ATTRIBUTESEPERATOR="|";
	public static final String ATTRIBUTELISTSTART="(";
	public static final String ATTRIBUTELISTEND=")";
	public static final String WRITERSEPERATOR=",";
	public static final String QUOTECHAR="'";
	public static final String ATTRIBUTETYPESEPERATOR="=";
