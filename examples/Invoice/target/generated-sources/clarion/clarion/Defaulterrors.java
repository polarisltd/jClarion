...
{
	public ClarionNumber number=Clarion.newNumber(53).setEncoding(ClarionNumber.USHORT);
	...
	public ClarionString _anon_44=Clarion.newString("An error was experienced during the creation of a record.|File: %File|Error: %ErrorText.").setEncoding(ClarionString.PSTRING);
	...
	public ClarionString _anon_52=Clarion.newString("This record was changed by another station. Those changes will now be displayed. Use the Ditto Button or Ctrl+H to recall your changes.").setEncoding(ClarionString.PSTRING);
	...
	public ClarionString _anon_84=Clarion.newString("Attempts to automatically number this record have failed.|File: %File|Key: %Key|Error: %ErrorText.|Try Again?").setEncoding(ClarionString.PSTRING);
	...
	public ClarionString _anon_92=Clarion.newString("The beginning of the file %File was encountered. Do you want to start again from the end of the file?").setEncoding(ClarionString.PSTRING);
	...
	public ClarionString _anon_96=Clarion.newString("The end of the file %File was encountered. Do you want to start again from the beginning?").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_97=Clarion.newNumber(Msg.CLOSEFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_98=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_99=Clarion.newString("File Access Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_100=Clarion.newString("File %File could not be closed.  Error: %ErrorText.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_101=Clarion.newNumber(Msg.OPENFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_102=Clarion.newNumber(Level.FATAL).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_103=Clarion.newString("File Access Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_104=Clarion.newString("File %File could not be opened.  Error: %ErrorText.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_105=Clarion.newNumber(Msg.PUTFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_106=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_107=Clarion.newString("Record was not updated").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_108=Clarion.newString("An error (%ErrorText) was experienced when making changes to the %File file.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_109=Clarion.newNumber(Msg.DELETEFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_110=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_111=Clarion.newString("Record was not deleted").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_112=Clarion.newString("An error (%ErrorText) was experienced when deleting a record from the %File file.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_113=Clarion.newNumber(Msg.CONFIRMDELETE).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_114=Clarion.newNumber(Level.USER).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_115=Clarion.newString("Confirm Delete").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_116=Clarion.newString("Are you sure you want to delete the highlighted record?").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_117=Clarion.newNumber(Msg.SAVERECORD).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_118=Clarion.newNumber(Level.USER).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_119=Clarion.newString("Save Record").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_120=Clarion.newString("Do you want to save the changes to this record?").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_121=Clarion.newNumber(Msg.LOGOUTFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_122=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_123=Clarion.newString("Transaction cancelled").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_124=Clarion.newString("Error: (%ErrorText) attempting to frame the transaction on %File.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_125=Clarion.newNumber(Msg.ABORTREADING).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_126=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_127=Clarion.newString("Record Retrieval Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_128=Clarion.newString("Error: (%ErrorText) attempting to access a record from the %File file.  Returning to previous window.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_129=Clarion.newNumber(Msg.VIEWOPENFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_130=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_131=Clarion.newString("View Open Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_132=Clarion.newString("Error: (%ErrorText) attempting to open the current VIEW. Filter and Range Limits ignored.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_133=Clarion.newNumber(Msg.ADDANOTHER).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_134=Clarion.newNumber(Level.USER).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_135=Clarion.newString("Record Added").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_136=Clarion.newString("This record has been added to the file. Do you want to add another record?").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_137=Clarion.newNumber(Msg.RECORDHELD).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_138=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_139=Clarion.newString("Record not read").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_140=Clarion.newString("A record held by another station was encountered reading from the %File file.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_141=Clarion.newNumber(Msg.ADDNEWRECORD).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_142=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_143=Clarion.newString("Add New Record?").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_144=Clarion.newString("Record match not found, do you wish to add a new one?").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_145=Clarion.newNumber(Msg.FIELDNOTINLIST).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_146=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_147=Clarion.newString("Value Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_148=Clarion.newString("The value of %Field must be in the list : %Message.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_149=Clarion.newNumber(Msg.NORECORDS).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_150=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_151=Clarion.newString("No Records").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_152=Clarion.newString("There are no records available to process.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_153=Clarion.newNumber(Msg.ACCESSDENIED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_154=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_155=Clarion.newString("Access Denied").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_156=Clarion.newString("Could not get write access to %File so trying read-only.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_157=Clarion.newNumber(Msg.USECLOSEDFILE).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_158=Clarion.newNumber(Level.PROGRAM).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_159=Clarion.newString("File Usage Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_160=Clarion.newString("Attempt to use file (%File) before it was opened").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_161=Clarion.newNumber(Msg.RECORDLIMIT).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_162=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_163=Clarion.newString("Record Limit Exceeded").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_164=Clarion.newString("Evaluation edition will not allow write-access to file %File. It will be opened for reading only.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_165=Clarion.newNumber(Msg.QBECOLUMNNOTSUPPORTED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_166=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_167=Clarion.newString("Unsupported QBE Column").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_168=Clarion.newString("The saved QBE column, %Field is not supported. It will be dropped from the query.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_169=Clarion.newNumber(Msg.SMTPERROR).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_170=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_171=Clarion.newString("SMTP Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_172=Clarion.newString("The following SMTP Error occurred: %Message ").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_173=Clarion.newNumber(Msg.NNTPERROR).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_174=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_175=Clarion.newString("NNTP Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_176=Clarion.newString("%Message ").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_177=Clarion.newNumber(Msg.WINSOCKERROR).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_178=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_179=Clarion.newString("Winsock Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_180=Clarion.newString("%Message ").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_181=Clarion.newNumber(Msg.WMFFILENOTVALID).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_182=Clarion.newNumber(Level.FATAL).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_183=Clarion.newString("WMF Parser Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_184=Clarion.newString("The File %File is not a valid WMF file.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_185=Clarion.newNumber(Msg.GETRECORDFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_186=Clarion.newNumber(Level.FATAL).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_187=Clarion.newString("WMF Parser Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_188=Clarion.newString("Get next record from file %File failed.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_189=Clarion.newNumber(Msg.WMFOBJECTIDNOTFOUND).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_190=Clarion.newNumber(Level.FATAL).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_191=Clarion.newString("WMF Parser Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_192=Clarion.newString("Cannot find %Field id. Parsing %File.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_193=Clarion.newNumber(Msg.WMFINVALIDCONTROL).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_194=Clarion.newNumber(Level.FATAL).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_195=Clarion.newString("WMF Parser Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_196=Clarion.newString("Invalid %Field control found. Parsing %File.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_197=Clarion.newNumber(Msg.WMFADDQUEUEFAILED).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_198=Clarion.newNumber(Level.FATAL).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_199=Clarion.newString("WMF Parser Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_200=Clarion.newString("Adding record to queue failed. Parsing %File.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_201=Clarion.newNumber(Msg.RWPPOORCOMMENT).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_202=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_203=Clarion.newString("Report Writer Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_204=Clarion.newString("Poorly Formed Comment String \"%Message\" at Position %Field.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_205=Clarion.newNumber(Msg.RWPUNKNOWNPROPERTY).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_206=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_207=Clarion.newString("Report Writer Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_208=Clarion.newString("Unknown Property %Message.").setEncoding(ClarionString.PSTRING);
	public ClarionNumber _anon_209=Clarion.newNumber(Msg.CONCURRENCYFAILEDFROMBROWSE).setEncoding(ClarionNumber.USHORT);
	public ClarionNumber _anon_210=Clarion.newNumber(Level.NOTIFY).setEncoding(ClarionNumber.BYTE);
	public ClarionString _anon_211=Clarion.newString("Record Retrieval Error").setEncoding(ClarionString.PSTRING);
	public ClarionString _anon_212=Clarion.newString("This record was changed or deleted by another station.|Error: (%ErrorText) attempting to access a record from the %File file.").setEncoding(ClarionString.PSTRING);
	...
	public Defaulterrors()
	{
		...
		this.addVariable("_anon_177",this._anon_177);
		this.addVariable("_anon_178",this._anon_178);
		this.addVariable("_anon_179",this._anon_179);
		this.addVariable("_anon_180",this._anon_180);
		this.addVariable("_anon_181",this._anon_181);
		this.addVariable("_anon_182",this._anon_182);
		this.addVariable("_anon_183",this._anon_183);
		this.addVariable("_anon_184",this._anon_184);
		this.addVariable("_anon_185",this._anon_185);
		this.addVariable("_anon_186",this._anon_186);
		this.addVariable("_anon_187",this._anon_187);
		this.addVariable("_anon_188",this._anon_188);
		this.addVariable("_anon_189",this._anon_189);
		this.addVariable("_anon_190",this._anon_190);
		this.addVariable("_anon_191",this._anon_191);
		this.addVariable("_anon_192",this._anon_192);
		this.addVariable("_anon_193",this._anon_193);
		this.addVariable("_anon_194",this._anon_194);
		this.addVariable("_anon_195",this._anon_195);
		this.addVariable("_anon_196",this._anon_196);
		this.addVariable("_anon_197",this._anon_197);
		this.addVariable("_anon_198",this._anon_198);
		this.addVariable("_anon_199",this._anon_199);
		this.addVariable("_anon_200",this._anon_200);
		this.addVariable("_anon_201",this._anon_201);
		this.addVariable("_anon_202",this._anon_202);
		this.addVariable("_anon_203",this._anon_203);
		this.addVariable("_anon_204",this._anon_204);
		this.addVariable("_anon_205",this._anon_205);
		this.addVariable("_anon_206",this._anon_206);
		this.addVariable("_anon_207",this._anon_207);
		this.addVariable("_anon_208",this._anon_208);
		this.addVariable("_anon_209",this._anon_209);
		this.addVariable("_anon_210",this._anon_210);
		this.addVariable("_anon_211",this._anon_211);
		this.addVariable("_anon_212",this._anon_212);
	}
}
