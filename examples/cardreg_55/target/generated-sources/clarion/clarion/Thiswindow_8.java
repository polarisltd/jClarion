...
public class Thiswindow_8 extends Reportmanager
{
	...
	public Thiswindow_8(ProgressWindow_1 progressWindow,Steplongclass progressMgr,Thisreport_1 thisReport,ClarionView processView,ClarionNumber progressThermometer,Report_1 report,Printpreviewclass previewer)
	{
	...
	public ClarionNumber init()
	{
		...
		Main.globalErrors.setProcedureName(Clarion.newString("PrintAccountPurchases"));
		...
		Main.iNIMgr.fetch(Clarion.newString("PrintAccountPurchases"),progressWindow);
		...
		thisReport.setFilter(Clarion.newString("TRA:TransactionType = 'C' AND TRA:SysID = GLO:CurrentSysID AND TRA:DateofTransaction  >= GLO:LowDate AND TRA:DateofTransaction <= GLO:HighDate"));
	...
	public ClarionNumber kill()
	{
		...
		if (this.opened.boolValue()) {
			Main.iNIMgr.update(Clarion.newString("PrintAccountPurchases"),progressWindow);
		}
