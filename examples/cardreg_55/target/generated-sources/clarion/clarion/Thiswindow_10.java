...
public class Thiswindow_10 extends Reportmanager
{
	...
	public Thiswindow_10(ProgressWindow_2 progressWindow,Steplongclass progressMgr,Thisreport_2 thisReport,ClarionView processView,ClarionNumber progressThermometer,Report_2 report,Printpreviewclass previewer)
	{
	...
	public ClarionNumber init()
	{
		...
		Main.globalErrors.setProcedureName(Clarion.newString("PrintAccountTransactionHistory"));
		...
		Main.iNIMgr.fetch(Clarion.newString("PrintAccountTransactionHistory"),progressWindow);
		...
		thisReport.setFilter(Clarion.newString("TRA:ReconciledTransaction = 1 AND TRA:SysID = GLO:CurrentSysID AND TRA:DateofTransaction  >= GLO:LowDate AND TRA:DateofTransaction <= GLO:HighDate"));
	...
	public ClarionNumber kill()
	{
		...
		if (this.opened.boolValue()) {
			Main.iNIMgr.update(Clarion.newString("PrintAccountTransactionHistory"),progressWindow);
		}
