...
public class ClarionClassCompileTest extends CompileTestHelper
{
	...
	public void testClassStatic()
	{
		ClassLoader cl=compile(
				...
				"result long\n",
				"myclass class\n",
				"appicon long(1),static\n",
				".\n",
				"   code\n",
				"   result=myclass.appicon\n",
				"   myclass.appicon+=1\n",
				"");
        ClarionNumber r = (ClarionNumber)getMainVariable(cl,"result");
        ...
        initProgram(cl);
        r = (ClarionNumber)getMainVariable(cl,"result");
        assertEquals(0,r.intValue());
        runClarionProgram(cl);
        assertEquals(1,r.intValue());
	}
	
	public void testPolymorphicConstruct()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class,type\n",
	...
	public void testPolymorphicConstruct2()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class,type\n",
	...
	public void testPolymorphicConstruct3()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class,type\n",
	...
	public void testPolymorphicConstruct4()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class,type\n",
				...
				"myclass.construct procedure()\n",
				"   code\n",
				"   result+=1+SELF.ifield\n",
				"myclass2.construct procedure()\n",
				"   code\n",
				"   PARENT.construct\n",
				"   result+=5+SELF.ifield\n",
				"");
        ClarionNumber r = (ClarionNumber)getMainVariable(cl,"result");
        assertEquals(0,r.intValue());
        runClarionProgram(cl);
        assertEquals(9,r.intValue());
		
	}
	
	
	public void testClarionBindParamMethod()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class\n",
				"func procedure(long),long\n",
				".\n",
				"result long\n",
				"  code\n",
				"  bind('func',myclass.func)\n",
				"  result=evaluate('func(2)')\n",
				//"  myclass.func(1)\n",
				"myclass.func procedure(long a)\n",
				"   code\n",
				"   return 3+a\n",
				"");
        ClarionNumber r = (ClarionNumber)getMainVariable(cl,"result");
	...
	public void testClarionBindMethodScopeVariable()
	{
		ClassLoader cl=compile(
				" program\n",
				"    map\n",
	...
	public void testClarionBindMethodScopeVariableInMethod()
	{
		ClassLoader cl=compile(
				" program\n",
				"    map\n",
	...
	public void testClarionBindNoParamMethod()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class\n",
	...
	public void testClarionSelfBindParamMethod()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class\n",
	...
	public void testClarionSelfIndirectBindParamMethod()
	{
		ClassLoader cl=compile(
				" program\n",
				"mysubclass class,type\n",
				"func procedure(long),long\n",
				".\n",
				"myclass class\n",
				"msc mysubclass\n",
				...
				"  myclass.init\n",
				"  result=evaluate('func(2)')\n",
				"mysubclass.func procedure(long a)\n",
				"   code\n",
				"   return 3+a\n",
				"myclass.init procedure\n",
				"   code\n",
				"  bind('func',self.msc.func)\n",
				"");
        ClarionNumber r = (ClarionNumber)getMainVariable(cl,"result");
        assertEquals(0,r.intValue());
        runClarionProgram(cl);
	...
	public void testClarionSelfBindNoParamMethod()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class\n",
	...
	public void testClarionBindField()
	{
		ClassLoader cl=compile(
				" program\n",
				"myclass class\n",
	...
	public void testPassInterface()
	{
        ClassLoader cl = compile(
                ...
                "init procedure\n",
                ".\n",
                "filedrop class,implements(wc)\n",
                ".\n",
                "myfiledrop class(filedrop)\n",
                ".\n",
                "handler class\n",
                "additem procedure(wc)\n",
                ".\n",
                "result long\n",
                "  code\n",
                "  handler.additem(myfiledrop.wc)\n",
                "handler.additem procedure(wc wc)\n",
                "  code\n",
                "  wc.init()\n",
                "filedrop.wc.init procedure()\n",
                "  code\n",
                "  result=1\n",
                "");
    ...
    public void testCompileDefinitionOnly()
    {
        ...
        Object o = (Object)instantiate(cl,ClarionCompiler.RAW_BASE+".Myclass");
        assertNotNull(o);
    ...
    public void testCompileDanglingType()
    {
        ...
        ClarionArray<ClarionNumber> result=getMainArrayVariableN(cl,"result");
        
        runClarionProgram(cl);

        assertEquals(12,result.get(1).intValue());
        assertEquals(24,result.get(2).intValue());
        assertEquals(-20,result.get(3).intValue());
    }
    ...
    */
    ...
    public void testOmittedProcedure2()
    {
        ClassLoader cl= compile(
                ...
                "   code\n",
                "   if omitted(1) then result+=1.\n",
                "   if omitted(p1) then result+=2.\n",
                "   if omitted(p2) then result+=4.\n",
                "   result+=8\n",
                "");
