...
public class CompileRealFileTest extends CompileTestHelper
{
    ...
    public void testErrorFunctions()
    {
        ...
        ClassLoader cl = compile(
                ...
                "   franch{7200H}='select ere i am jh'  ! prop:sql\n",		
                "   assert(errorcode()=90,'#1')\n",
                "   assert(error()='ERROR: syntax error at or near \"am\"<10>  Position: 14','#2')\n",
                "   assert(fileerrorcode()='42601','#3')\n",
                "   assert(fileerror()='ERROR: syntax error at or near \"am\"<10>  Position: 14','#4')\n",
                "   assert(errorfile()='testfranch','#5')\n",

                "   poperrors\n",

                "   assert(errorcode()=0,'#1')\n",
                "   assert(error()='OK','#2')\n",
                "   assert(fileerrorcode()='','#3')\n",
                "   assert(fileerror()='','#4')\n",
                "   assert(errorfile()='','#5')\n",
        "");
