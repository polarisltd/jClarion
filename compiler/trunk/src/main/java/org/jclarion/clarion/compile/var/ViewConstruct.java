...
public class ViewConstruct extends Scope
{
    ...
    public ViewConstruct(ScopeStack stack,String base,String name)
    {
    	super(stack);
        this.label=name;
        javaClass=new ViewJavaClass(base,this);
    }

    public void link(Scope s)
    {
    	s.getStack().compiler().repository().add(getJavaClass(),s.getPackage(),label);
