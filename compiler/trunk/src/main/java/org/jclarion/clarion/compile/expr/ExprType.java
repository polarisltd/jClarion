...
public abstract class ExprType implements JavaDependency 
{
    ...
    public static final FilledExprType runnable;
    public static final FilledExprType rawastring;
    ...
    private static Map<String,ExprType> javaMappings=new HashMap<String,ExprType>();
    
	public static Class<?> BASE_CLASSES[] = new Class<?>[] {
			ICriticalSection.class, ISyncObject.class,
			IWaitableSyncObject.class, IMutex.class, ISemaphore.class,
    ...
    static {
        ...
        runnable   = new RawExprType("runnable",".toString()","Runnable");
        ...
        rawastring   = new RawExprType("rawastring",".toString()","String[]");
        ...
        group       = new SystemExprType("group",object,0,null,null) {
            @Override
            public Expr field(Expr in, String field,Scope scope) {
        ...
        group.add(new MemoryModelCastFactory(group));
        ...
        rawint.add(new DecoratedCastFactory(rawstring,JavaPrec.POSTFIX,"Clarion.newNumber(",JavaPrec.POSTFIX,").intValue()"));
        ...
        javaMappingsPut(Object.class,object);
        javaMappingsPut(String.class,rawstring);
        javaMappingsPut(int.class,rawint);
        javaMappingsPut(Integer.class,rawint);
        javaMappingsPut(boolean.class,rawboolean);
        javaMappingsPut(Boolean.class,rawboolean);
        // raw decimal not supported
        
        javaMappingsPut(ClarionObject.class,any);
        javaMappingsPut(ClarionAny.class,concrete_any);

        javaMappingsPut(ClarionString.class,string);
        javaMappingsPut(ClarionDecimal.class,decimal);
        javaMappingsPut(ClarionNumber.class,number);
        javaMappingsPut(ClarionBool.class,bool);
        javaMappingsPut(ClarionReal.class,real);
        javaMappingsPut(ClarionBlob.class,blob);
        javaMappingsPut(ClarionGroup.class,group);
        javaMappingsPut(ClarionQueue.class,queue);
        javaMappingsPut(ClarionFile.class,file);
        javaMappingsPut(ClarionKey.class,key);
        javaMappingsPut(ClarionView.class,view);

        javaMappingsPut(AbstractTarget.class,target);
        javaMappingsPut(AbstractWindowTarget.class,windowtarget);
        javaMappingsPut(ClarionWindow.class,window);
        javaMappingsPut(ClarionApplication.class,window);
        javaMappingsPut(ClarionReport.class,report);
        
        DefaultJavaImporter importer = new DefaultJavaImporter();
        for (Class<?> c : BASE_CLASSES) {
        	importer.process(c.getName());
        }       
    };
    
    private static void javaMappingsPut(Class<?> clz,ExprType exp)
    {
    	javaMappings.put(clz.getName(),exp);
    }

    public static ExprType getBasicJavaMapping(String clazz)
    {
        return javaMappings.get(clazz);
    }

    public static ExprType getBasicJavaMapping(Class<?> clazz)
    {
        return javaMappings.get(clazz.getName());
    }
    
    public static void addBasicJavaMapping(String clazz,ExprType type) {
        javaMappings.put(clazz,type);
    }       
    ...
    public abstract Expr field(Expr in,String field,Scope callingScope);
