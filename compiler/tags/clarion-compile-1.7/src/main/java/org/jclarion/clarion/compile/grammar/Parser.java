...
public class Parser extends AbstractParser
{
    ...
    public Parser(Lexer input)
    {
        ...
        setParser(this);
        lex=input;
        expr=new ExprParser(this,lex);
        var=new VariableParser(this,lex);
        prototype=new PrototypeParser(this,lex);
        stmt=new StatementParser(this,lex);
        equate=new EquateParser(this,lex);
        target=new TargetParser(this,lex);
    ...
    public void compileProgram()
    {
        ...
        Procedure mp = new Procedure("main",new Param[] { 
                new Param("args",ExprType.rawstring.changeArrayIndexCount(1),
        ...
        if (lex.getBeginCount()>0) error("Code has open begin blocks");
