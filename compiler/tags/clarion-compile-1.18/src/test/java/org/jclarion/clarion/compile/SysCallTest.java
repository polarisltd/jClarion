...
public class SysCallTest extends CompileTestHelper
{
    ...
    public void testCompileStringArray()
    {
        ...
        ClarionArray<ClarionString> co = getMainArrayVariableS(cl,"test");
        runClarionProgram(cl);
        assertEquals("hell      ",co.get(1).toString());
        assertEquals("world     ",co.get(2).toString());
        assertEquals("llo       ",co.get(3).toString());
