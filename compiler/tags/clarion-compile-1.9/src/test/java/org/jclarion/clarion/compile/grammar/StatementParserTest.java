...
public class StatementParserTest extends TestCase 
{
    ...
    public void testAssignToSplitStringInAnArray()
    {
        ...
        ClarionObject test[] = getMainVariableArray(cl,"test");
        assertEquals("          ",test[1].toString());
        assertEquals("          ",test[2].toString());
        
        test[1].setValue("Hello");
        runClarionProgram(cl);
        assertEquals(" llo      ",test[2].toString());

        test[1].setValue("apPle");
        runClarionProgram(cl);
        assertEquals(" Ple      ",test[2].toString());
    }
    ...
    public ClarionObject[] getMainVariableArray(ClassLoader cl,String name)
    {
        try {
            Class<?> c = cl.loadClass("clarion.Main");
            assertNotNull(c);
