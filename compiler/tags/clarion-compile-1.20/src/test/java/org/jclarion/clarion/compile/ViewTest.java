...
public class ViewTest extends CompileTestHelper
{
    ...
    public void testJoinA()
    {
        ClassLoader cl = compile(
                ...
                "prop:fieldsfile equate(-1)\n",
                "prop:field      equate(-1)\n",
                "prop:fields equate(7312h)\n",
                
                "   code\n",
                "   assert(4=myView{Prop:Fields})\n",
                "   MyFile &= myView{Prop:fieldsfile,1}\n",
                "   assert(MyFile &= notes)\n",
                "   MyFile &= myView{Prop:fieldsfile,2}\n",
                "   assert(MyFile &= browseledger_view)\n",
                "   MyFile &= myView{Prop:fieldsfile,3}\n",
                "   assert(MyFile &= browseledger_view)\n",
                "   MyFile &= myView{Prop:fieldsfile,4}\n",
                "   assert(MyFile &= notes)\n",

                "   assert(3=myView{PRop:field,1})\n",
                "   assert(17=myView{PRop:field,2})\n",
                "   assert(18=myView{PRop:field,3})\n",
                "   assert(4=myView{PRop:field,4})\n",
                "");
