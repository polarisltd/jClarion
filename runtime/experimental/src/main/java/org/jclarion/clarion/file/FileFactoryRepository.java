...
public class FileFactoryRepository extends ClarionFileFactory
{
    ...
    */
    ...
    {
    	return getRandomAccessFile(file,true);
    }
    
    @Override
    public ClarionRandomAccessFile getRandomAccessFile(String file,boolean useGUIModel) throws IOException 
    {
        for ( ClarionFileFactory cff : factories ) {
            ClarionRandomAccessFile result = cff.getRandomAccessFile(file,useGUIModel);
            if (result!=null) {
