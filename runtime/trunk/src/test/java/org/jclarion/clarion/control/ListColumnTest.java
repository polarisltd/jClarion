...
public class ListColumnTest extends TestCase {
    ...
    public void testReconstruct()
    {
    	String tests[] = new String[] {
    			"20LY@s10@Z(1)30LY@s20@",
    			"20L@s10@Z(1)30LY@s20@",
    			"20LJ@s10@Z(1)30LY@s20@",
    			"51D(14)|M*~Total~L(2)@n$10.2@",
    	        "13L(2)J@s1@Z(1)14L(2)J@s1@Z(1)78L|Y~Part Number~L@s20@107L(2)|Y~Description~L@s35@"+
    	        "Z(1)27L(2)|Y~Loc~L@s6@Z(1)24R(2)|Y~Stk~L@P<<<<<<<<#P@Z(1)24R(2)|Y~Ord~L@s5@Z(1)24R(2)|Y"+
    	        "~Req~L@P<<<<<<<<#P@Z(1)24R(2)|Y~Sup~L@P<<<<<<<<#P@Z(1)20R(2)|Y~Price~L@n$10.2@Z(1)",        
    	        "20L(2)|M~F1~L@s20@20L(2)|M~F2~L@s20@20L(2)|M~F3~L@n9@20L(2)|M~F4~L@n$12.2@",
    	        "86L(2)|M*~Part Number~L@s20@" +
    	        "127L(2)I|M*~Description~L@s30@" +
    	        "28R(2)|M*~QoH~L@s7@" };

    	for (String t : tests ) {
    		ListColumn lc[] = ListColumn.construct(t);
    		
    		String x = ListColumn.deconstruct(lc);
    ...
    public void testReconstructWithNewSize()
    {
    	ListColumn lc[] = ListColumn.construct("20LY@s10@Z(1)30LY@s20@");
    	lc[0].setWidth(25);
    	lc[1].setWidth(35);
    	assertEquals("25LY@s10@Z(1)35LY@s20@",ListColumn.deconstruct(lc));
    }
}
