...
public class CDateTest extends TestCase {
    ...
    public void testAge()
    {
        assertEquals("4 DAYS",CDate.age(CDate.date(2,20,2010),CDate.date(2,24,2010)));
        assertEquals("5 DAYS",CDate.age(CDate.date(2,26,2010),CDate.date(3,3,2010)));
        assertEquals("36 DAYS",CDate.age(CDate.date(2,26,2010),CDate.date(4,3,2010)));
        assertEquals("3 MOS",CDate.age(CDate.date(2,26,2010),CDate.date(5,3,2010)));
        assertEquals("15 MOS",CDate.age(CDate.date(2,26,2010),CDate.date(5,3,2011)));
        assertEquals("32 YRS",CDate.age(CDate.date(10,2,1977),CDate.date(5,3,2010)));
        assertEquals("33 YRS",CDate.age(CDate.date(10,2,1977),CDate.date(12,3,2010)));
        assertEquals("33 YRS",CDate.age(CDate.date(10,2,1977),CDate.date(10,2,2010)));
    }
