...
public class WindowTest extends SwingTC
{
    ...
    {
    	assertNotNull(CWin.getTarget());
    }
    
    public void testDisplayNoWindow()
    {
    	CWin.display();
    }
    ...
    {
    	ClarionWindow ca = new ClarionWindow();
    	ca.setAt(10,10,100,100);
    	ca.setText("test");
    	...
    	ca.post(Event.USER,1,false);
    	ca.post(Event.USER,2,false);
    	ca.post(Event.USER,3,false);
    	ca.post(Event.USER,4,true);
    	ca.post(Event.USER,5,true);
    	ca.post(Event.USER,6,true);
    	ca.post(Event.USER,7,false);
    	ca.post(Event.USER,8,false);
    	ca.post(Event.USER,9,false);
    	CWin.post(Event.USER,null,null,1);

    	for (int i : new int[] { 0,6,5,4,1,2,3,7,8,9} ) {
        	assertTrue(ca.accept());
        	assertEquals(Event.USER,CWin.event());
        	assertEquals(i,CWin.field());
        	ca.consumeAccept();    		
    	}

    	ca.post(Event.USER,20,false);
    	assertTrue(ca.accept());
    	assertEquals(Event.USER,CWin.event());
    	assertEquals(20,CWin.field());
    	ca.post(Event.USER,21,true);
    	ca.consumeAccept();    		

    	assertTrue(ca.accept());
    	assertEquals(Event.USER,CWin.event());
    	assertEquals(21,CWin.field());
    	ca.consumeAccept();    		
    ...
    {
        final ClarionWindow ca = new ClarionWindow();
    ...
    public void testKeyBufferingAcrossWindows()
    {
    	ClarionWindow parent = new ClarionWindow();
    	parent.setText("Parent");
    	parent.setAt(5,5,100,100);
    	ButtonControl button  =new ButtonControl();
    	button.setText("&Press Me");
    	button.setAt(10,10,null,null);
    	parent.add(button);
    	
    	ClarionWindow child = new ClarionWindow();
    	child.setText("Child");
    	child.setAt(25,25,100,100);
    	ButtonControl b2  =new ButtonControl();
    	b2.setText("No &Press Me");
    	b2.setAt(10,10,null,null);
    	child.add(b2);

    	
    	ClarionWindow wu = new ClarionWindow();
    	wu.setText("Warm Up Act");
    	wu.setAt(5,5,100,100);
    	wu.open();
    	
    	assertTrue(wu.accept());
    	assertEquals(Event.OPENWINDOW,CWin.event());
    	wu.consumeAccept();
    	...
    	assertTrue(parent.accept());
    	assertEquals(Event.OPENWINDOW,CWin.event());
    	parent.consumeAccept();
    	
    	assertTrue(parent.accept());
    	assertEquals(Event.SELECTED,CWin.event());
    	assertEquals(button.getUseID(),CWin.field());
    	parent.consumeAccept();
    ...
    public void testKeyBufferingAcrossMDIWindows()
    {
    	ClarionWindow parent = new ClarionWindow();
    	parent.setText("Parent");
    	parent.setMDI();
    ...
    public void testFieldDetailsNotLostWhenInChild()
    {
        ...
        final ButtonControl cb = new ButtonControl();
    ...
    public void testResize() throws InterruptedException
    {
        ...
        assertEquals(500,w.getProperty(Prop.CLIENTWIDTH).intValue());
        assertEquals(249,w.getProperty(Prop.CLIENTHEIGHT).intValue());
        
        assertTrue(w.accept());
        assertEquals(Event.OPENWINDOW,CWin.event());
        w.consumeAccept();

        Container c = (Container)cc(w).getWindow();
        ...
        Thread.sleep(100);
        getRobot().mouseMove(c,d.width+cc(w).getFontWidth()*10/4,d.height+cc(w).getFontHeight()*15/8);
        Thread.sleep(100);
        ...
        wi = w.getProperty(Prop.CLIENTWIDTH).intValue();
        he = w.getProperty(Prop.CLIENTHEIGHT).intValue();
        
        assertTrue(""+wi,Math.abs(wi-515)<=2 || Math.abs(wi-510)<=2);
        assertTrue(""+he,Math.abs(he-265)<=2);
    ...
    public void testSkipKeyFocusCanGetFocusOnExplicitRequest()
    {
        ClarionWindow w = new ClarionWindow();
        w.setText("Hello World");
        w.setAt(null,null,500,250);
    ...
    public void testSheetRemembersFocusOnRegain() throws InterruptedException
    {
        ...
        java.awt.Container c = cc(CWin.getWindowTarget()).getWindow();
    ...
    public void testProgrammaticChangeTitle()
    {
        ...
        assertEquals("New Hello World",((JDialog)cc(w).getWindow()).getTitle());
