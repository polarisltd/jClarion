...
public class EntryTest extends SwingTC {
    ...
    public void testRightClickTools()
    {
        ...
        rightClick(e1,10);
        assertEquals("Hello",CWin.getClipboard().toString());
        ...
        getRobot().mousePress(cc(e2).getComponent(),0,0);
        getRobot().mouseRelease();
        rightClick(e2,10);
        assertEquals("1234.56",CWin.getClipboard().toString());

        waitForEventQueueToCatchup();
        getRobot().mousePress(cc(e2).getComponent(),0,10);
        waitForEventQueueToCatchup();
        for (int scan=0;scan<15;scan++) {
        	getRobot().mouseMove(cc(e2).getComponent(),scan*3,10);
            waitForEventQueueToCatchup();
        }
        getRobot().mouseRelease();

        rightClick(e2,10);
        assertEquals("$1,23",CWin.getClipboard().toString());
        ...
        CWin.setClipboard(new ClarionString("Pasted"));
        waitForEventQueueToCatchup();
        ...
        assertEquals("Pasted",e1.getProperty(Prop.SCREENTEXT).toString());
        ...
        assertEquals(e1.getUseID(),CWin.field());
        assertEquals("Pasted",cs.toString().trim());
        w.consumeAccept();
        ...
        waitForEventQueueToCatchup();
        getRobot().mousePress(cc(e1).getComponent(),0,10);
        waitForEventQueueToCatchup();
        for (int scan=0;scan<10;scan++) {
        	getRobot().mouseMove(cc(e1).getComponent(),scan*3,10);
            waitForEventQueueToCatchup();
        }
        getRobot().mouseRelease();
        ...
        assertEquals("Pastedted",e1.getProperty(Prop.SCREENTEXT).toString());
        ...
        assertEquals(Event.ACCEPTED,CWin.event());
        assertEquals(e1.getUseID(),CWin.field());
        assertEquals("Pastedted",cs.toString().trim());
        w.consumeAccept();
    ...
    private void rightClick(AbstractControl s2,int yofs)
    {
        waitForEventQueueToCatchup();
        getRobot().mousePress(cc(s2).getComponent(),5,5,InputEvent.BUTTON3_MASK);
        getRobot().mouseRelease(InputEvent.BUTTON3_MASK);
        waitForEventQueueToCatchup();
        getRobot().mousePress(cc(s2).getComponent(),10,5+yofs);
        getRobot().mouseRelease();
        waitForEventQueueToCatchup();
    }

    private void rightClick(AbstractControl s2)
    {
        waitForEventQueueToCatchup();
        getRobot().mousePress(cc(s2).getComponent(),5,5,InputEvent.BUTTON3_MASK);
        getRobot().mouseRelease(InputEvent.BUTTON3_MASK);
