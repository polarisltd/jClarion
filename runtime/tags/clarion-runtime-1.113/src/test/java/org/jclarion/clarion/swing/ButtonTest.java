...
public class ButtonTest extends SwingTC {
    ...
    public void testPreferredSizing()
    {
        ...
        assertEquals(15,b.getProperty(Prop.HEIGHT).intValue());
        
        w.close();
    }

    public void testPreferredSizing2()
    {
        final ClarionWindow w = new ClarionWindow();
        w.setText("Hello World");
        w.setAt(null,null,200,100);
        ButtonControl b =  new ButtonControl();
        b.setText("All Good").setAt(20,20,null,null);
        w.add(b);
        int id = w.register(b);
        w.open();
        ...
        assertEquals(40,b.getProperty(Prop.WIDTH).intValue());
        assertEquals(15,b.getProperty(Prop.HEIGHT).intValue());
