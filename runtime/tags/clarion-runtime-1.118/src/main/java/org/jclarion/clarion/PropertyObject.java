...
public abstract class PropertyObject 
{
    ...
    public List<? extends PropertyObject> getChildren() {
    	return Collections.emptyList();
    }
    
    public int getChildIndex(PropertyObject control)
    {
        int count=0;
        for (PropertyObject test : getChildren()) {
    ...
    */
    ...
    public void setProperty(ClarionObject key, ClarionObject index,ClarionObject value) 
    {
        ...
        throw new RuntimeException("Not yet implemented:"+Prop.getPropString(key.intValue())+" : "+index);
    }
