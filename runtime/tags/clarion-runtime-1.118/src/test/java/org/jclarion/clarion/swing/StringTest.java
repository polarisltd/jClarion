...
public class StringTest extends SwingTC
{
    ...
    public void testDefaultSize()
    {
        ...
        ClarionString cs = new ClarionString("Hello Big Wide World");
        s1.setText("@s20").setAt(20,20,80,null);
        s1.use(cs);
        w.add(s1);
        
        assertNull(s1.getRawProperty(Prop.HEIGHT,false));
        ...
        assertEquals(80,s1.getProperty(Prop.WIDTH).intValue());
        assertEquals(8,s1.getRawProperty(Prop.HEIGHT,false).intValue());
    ...
    public void testResize()
    {
        ...
        StringControl s1 = new StringControl();
        ClarionString cs = new ClarionString("Hello Big Wide World");
        s1.setText("@s20").setAt(20,20,80,6);
        s1.use(cs);
        w.add(s1);
        ...
        w.accept();
        s1.setProperty(Prop.WIDTH,120);
        w.consumeAccept();
        
        waitForEventQueueToCatchup();
        
        assertEquals(120,s1.getProperty(Prop.WIDTH).intValue());
        assertEquals(8,s1.getProperty(Prop.HEIGHT).intValue());
