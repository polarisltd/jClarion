...
public class CMemory {
    ...
    public static int instance(Threaded o,Integer thread)
    {
        if (o==null) return 0;
        return address(o.getThreadState(thread==null || thread==0 ? Thread.currentThread() : CRun.getThread(thread)));
    }
    ...
    public static int instance(Object o,Integer thread)
    {
        ...
        if (o instanceof Threaded) {
            return instance((Threaded)o,thread);
        }
        return address(o);
    }
