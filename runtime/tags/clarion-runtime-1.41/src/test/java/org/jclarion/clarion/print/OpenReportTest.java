...
public class OpenReportTest extends TestCase 
{
    ...
    public void testPdfOuputRequiresManualInspection() throws InterruptedException, PrinterException
    {
        ...
        rd3.add((new StringControl()).setCenter().setAt(0,600,2000,0).setText("Center Justified"));
        rd3.add((new StringControl()).setCenter().setAt(0,900,2000,0).setText("CENTER JUSTIFIED"));
        
        rd3.add((new StringControl()).setCenter().setAt(0,1200,2000,0).setText("CENTER JUSTIFIED!")
                .setFont("Monospaced", 10, 0x8080ff,org.jclarion.clarion.constants.Font.BOLD,null));

        rd3.add((new StringControl()).setCenter().setAt(0,1300,2000,0).setText("M.M.M.M.M.M.M.M.M")
                .setFont("Monospaced", 10, 0x8080ff,org.jclarion.clarion.constants.Font.BOLD,null));
    ...
    public void assertDetail(String text,int x,int y,Iterator<PrintObject> po)
    {
        assertDetail(0,text,x,y,po);
    }
    
    public void assertDetail(int ofs,String text,int x,int y,Iterator<PrintObject> po)
    {
