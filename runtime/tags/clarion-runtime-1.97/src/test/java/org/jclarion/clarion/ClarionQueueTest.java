...
public class ClarionQueueTest extends TestCase {
    ...
    public static class TestClarionQueue extends ClarionQueue
    {
        ...
        public ClarionArray<ClarionDecimal> da = new ClarionDecimal(11,3).dim(5);
        public RefVariable<Object> o=new RefVariable<Object>();
        public RefVariable<ClarionDecimal> dr=new RefVariable<ClarionDecimal>();
    ...
    public void testSubOrderSearch2()
    {
    	int v[]=new int[] {10,17,4,11,25,19,20,6,12,22 };    	
        TestClarionQueue q = new TestClarionQueue();
        for (int scan=0;scan<20;scan++) {
            q.d1.setValue(5);
            q.s1.setValue(scan%2==1 ? "A" : "B");
            q.n1.setValue(v[scan/2]);
            q.add(q.ORDER().ascend(q.s1).ascend(q.n1));
        }    	
    ...
    public void testSubOrderSearch()
    {
    	int v[]=new int[] {10,17,4,11,25,19,20,6,12,22 };    	
        TestClarionQueue q = new TestClarionQueue();
        for (int scan=0;scan<20;scan++) {
        ...
        q.get(q.ORDER().ascend(q.s1));
        assertEquals(30,CError.errorCode());
        assertEquals(20,q.getPointer());
    }
    
    public void testActiveOrderingGetWithOrderWithIsSubsetOfOtherDefinedOrder()
    {
        TestClarionQueue q = new TestClarionQueue();
        ...
        for (int scan=0;scan<20;scan++) {
            q.d1.setValue(5);
            q.s1.setValue(scan%2==1 ? "A" : "B");
            q.n1.setValue(Math.random()*scan);
            q.add();
        }
        ...
        q.s1.setValue("B");
        q.get(Clarion.newString("+S1"));
        assertEquals(11,q.getPointer());

        q.sort(new ClarionString("+d1,+s1,+n1"));
        q.clear();
        q.d1.setValue(5);
        q.get(Clarion.newString("+d1"));
        assertEquals(1,q.getPointer());
    }
    ...
    public void testAdd() {
        ...
        q.n1.setValue(10);
        q.d1.setValue("12.3");
        q.da.get(4).setValue(-1);
        q.dr.set(new ClarionDecimal("13.2"));
        q.o.set(new Object());
        Object o1 = q.o.get();
        ...
        q.n1.setValue(20);
        q.d1.setValue("20.5");
        q.da.get(4).setValue(10);
        q.dr.set(new ClarionDecimal("100"));
        q.o.set(new Object());
        Object o2 = q.o.get();
        ...
        for (int scan=0;scan<2;scan++) {
            ...
            assertEquals("-1.000", q.da.get(4).toString());
            assertEquals("13.2", q.dr.get().toString());
            assertSame(o1, q.o.get());

            q.get(2);
            assertEquals("World     ", q.s1.toString());
            assertEquals(20, q.n1.intValue());
            assertEquals("20.50", q.d1.toString());
            assertEquals("10.000", q.da.get(4).toString());
            assertEquals("100", q.dr.get().toString());
            assertSame(o2, q.o.get());

            q.get(3);
            assertEquals("Yeah      ", q.s1.toString());
            assertEquals(21, q.n1.intValue());
            assertEquals("20.60", q.d1.toString());
            assertEquals("-11.000", q.da.get(4).toString());
            assertNull(q.dr.get());
            assertNull(q.o.get());
        }
    }
    ...
    public void testSortOrder() {
        ...
        q.d1.setValue("20.6");
        q.da.get(4).setValue(-11);
        q.da.get(1).setValue(3);
        q.dr.set(null);
        q.o.set(null);

        q.add();

        q.get(1);assertEquals(1,q.da.get(1).intValue());
        q.get(2);assertEquals(2,q.da.get(1).intValue());
        q.get(3);assertEquals(3,q.da.get(1).intValue());
        ...
        q.get(1);assertEquals(3,q.da.get(1).intValue());
        q.get(2);assertEquals(1,q.da.get(1).intValue());
        q.get(3);assertEquals(2,q.da.get(1).intValue());
        ...
        q.dr.setValue(new ClarionDecimal(10));
        q.sort(new ClarionString("s1,n1"));
        ...
        q.get(1);assertEquals(3,q.da.get(1).intValue());
        q.get(2);assertEquals(2,q.da.get(1).intValue());
        q.get(3);assertEquals(1,q.da.get(1).intValue());
    ...
    public void testGetOrder()
    {
        ...
        q.s1.setValue("Hello");
        q.get(q.ORDER().ascend(q.s1));
        assertEquals(1,q.da.get(1).intValue());
        assertEquals(0,CError.errorCode());

        q.clear();
        q.s1.setValue("Yeah");
        q.get(q.ORDER().ascend(q.s1));
        assertEquals(3,q.da.get(1).intValue());
        assertEquals(0,CError.errorCode());

        q.clear();
        q.d1.setValue("20.5");
        q.get(q.ORDER().ascend(q.d1));
        assertEquals(2,q.da.get(1).intValue());
        assertEquals(0,CError.errorCode());
        ...
        q.s1.setValue("AAA");
        q.get(q.ORDER().ascend(q.s1));
        assertEquals(0,q.da.get(1).intValue());
