...
public class ClarionNumberTest extends TestCase 
{
    ...
    public void testDimInt() {
        ...
        ClarionNumber l[] = (new ClarionNumber(20)).dim(5);
        
        assertEquals(6,l.length);
        assertNull(l[0]);
        for (int scan=1;scan<6;scan++) {
            assertEquals(20,l[scan].intValue());
        }
    }

    public void testDimInt2() {
        
        ClarionNumber l[][] = (new ClarionNumber(20)).dim(5,6);
        ...
        for (int s1=1;s1<=5;s1++) {
            assertNull(l[s1][0]);
            for (int s2=1;s2<=6;s2++) {
                assertEquals(20,l[s1][s2].intValue());
            }
        }
    }
    ...
    public void testDimInt3() {
        ...
        ClarionNumber l[][][] = (new ClarionNumber(20)).dim(6,5,4);
        ...
        for (int s1=1;s1<=6;s1++) {
            for (int s2=1;s2<=5;s2++) {
                ...
                for (int s3=1;s2<=4;s2++) {
                    ...
                    assertEquals(20,l[s1][s2][s3].intValue());
                }
            }
        }
    }
    ...
    private void doTestBackAndForward(int encoding,int from,int to)
    {
        ...
        try {
            ...
            o.deserialize(bais);
            assertEquals("Not at eof",-1,bais.read());
