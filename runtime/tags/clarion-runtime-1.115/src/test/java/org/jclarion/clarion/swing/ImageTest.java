...
public class ImageTest extends SwingTC
{
	...
	public void testPrintPreview()
	{
		...
		ClarionString img = new ClarionString();
		...
		rd.add( (new ImageControl()).setText(img).setAt(3000,0,1000,1000));
		Random r = new Random();
		for (int scan=0;scan<10;scan++) {
		...
		cr.open();
		img.setValue("test-image.jpg");
		rd.print();
		rd.print();
		img.setValue("test-image-404.jpg");
		rd.print();
		rd.print();
		cr.endPage();
	...
	/*
	public void xTestPreview()
	{
		ClarionString cs = new ClarionString();
		cs.setValue("/home/barney/tmp/blank.png");
		CWin.fileDialog("test",cs,"Images|*.png",0);
	}
	*/
