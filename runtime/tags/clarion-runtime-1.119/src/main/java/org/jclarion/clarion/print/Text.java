...
public class Text extends AbstractElement implements TextElement
{
    ...
    @Override
 	public PrintElement split(Page report,PrintContext g,int reduceHeight) {
 		return new Text(control,unformat,text,x1,y1,x2,y2,justify,justifyOffset,color,font,transparent);
 	}        
    ...
    public void paint(Page r,PrintContext c) {
        ...
        c.clip(x1, y1, x2-x1+1+rightPadding, y2-y1+1);
	...
	public Object[] getMetaData() {
		return new Object[] { x1,y1,x2,y2,text,justify.ordinal(),justifyOffset,color,font,transparent };
	}
	...
	public Text(Object[] o) {
		...
		justifyOffset=(Integer)o[6];
		color=(Color)o[7];
		font=(Font)o[8];
		transparent=(Boolean)o[9];
	}
}
