...
public abstract class ClarionObject extends ClarionMemoryModel implements ClarionCloneable
{
    private String       name;
    ...
    public final void adjustNull(boolean b) {
    	if (owner==null) return;
    	if (!(owner instanceof ClarionFile)) return;
    	((ClarionFile)owner).alterNull(this,b);
	}
