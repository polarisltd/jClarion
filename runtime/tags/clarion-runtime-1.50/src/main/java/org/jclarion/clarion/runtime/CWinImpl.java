...
public class CWinImpl {
    ...
    public java.awt.Image getImageFromBinaryData(ClarionObject content)
    {
        ...
        try {
            ...
            return Toolkit.getDefaultToolkit().createImage(sos.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public java.awt.Image getImage(String name, int prefx, int prefy) 
    {
        ...
        if (is == null) {
            ...
            try {
                ...
                cache=name+"_"+lastModified;
                i=getImageFromCache(cache);
                if (i!=null) return i;
                
                ClarionRandomAccessFile f = ClarionFileFactory.getInstance()
                        .getRandomAccessFile(name.trim());
