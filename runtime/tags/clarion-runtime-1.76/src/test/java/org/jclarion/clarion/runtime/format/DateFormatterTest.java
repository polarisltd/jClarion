...
public class DateFormatterTest extends TestCase {
    ...
    public void testFrench()
    {
        ...
        doTestFormat("janvier 12, 2009","######### <#, ####","@d4",CDate.date(1,12,2009)+"");
        doTestFormat("février 12, 2009","######### <#, ####","@d4",CDate.date(2,12,2009)+"");
        doTestFormat("mars 12, 2009","######### <#, ####","@d4",CDate.date(3,12,2009)+"");
        doTestFormat("avril 12, 2009","######### <#, ####","@d4",CDate.date(4,12,2009)+"");
        doTestFormat("mai 12, 2009","######### <#, ####","@d4",CDate.date(5,12,2009)+"");
        doTestFormat("juin 12, 2009","######### <#, ####","@d4",CDate.date(6,12,2009)+"");
        doTestFormat("juillet 12, 2009","######### <#, ####","@d4",CDate.date(7,12,2009)+"");
        doTestFormat("août 12, 2009","######### <#, ####","@d4",CDate.date(8,12,2009)+"");
        doTestFormat("septembre 12, 2009","######### <#, ####","@d4",CDate.date(9,12,2009)+"");
        doTestFormat("octobre 12, 2009","######### <#, ####","@d4",CDate.date(10,12,2009)+"");
        doTestFormat("novembre 12, 2009","######### <#, ####","@d4",CDate.date(11,12,2009)+"");
        doTestFormat("décembre 12, 2009","######### <#, ####","@d4",CDate.date(12,12,2009)+"");

        doTestFormat("janv. 12, 2009","##### <#, ####","@d3",CDate.date(1,12,2009)+"");
        doTestFormat("févr. 12, 2009","##### <#, ####","@d3",CDate.date(2,12,2009)+"");
        doTestFormat("mars 12, 2009","##### <#, ####","@d3",CDate.date(3,12,2009)+"");
        doTestFormat("avr. 12, 2009","##### <#, ####","@d3",CDate.date(4,12,2009)+"");
        doTestFormat("mai 12, 2009","##### <#, ####","@d3",CDate.date(5,12,2009)+"");
        doTestFormat("juin 12, 2009","##### <#, ####","@d3",CDate.date(6,12,2009)+"");
        doTestFormat("juil. 12, 2009","##### <#, ####","@d3",CDate.date(7,12,2009)+"");
        doTestFormat("août 12, 2009","##### <#, ####","@d3",CDate.date(8,12,2009)+"");
        doTestFormat("sept. 12, 2009","##### <#, ####","@d3",CDate.date(9,12,2009)+"");
        doTestFormat("oct. 12, 2009","##### <#, ####","@d3",CDate.date(10,12,2009)+"");
        doTestFormat("nov. 12, 2009","##### <#, ####","@d3",CDate.date(11,12,2009)+"");
        doTestFormat("déc. 12, 2009","##### <#, ####","@d3",CDate.date(12,12,2009)+"");
        
        DateFormat df = new DateFormat("@d6.");
        assertEquals("<#.<#.####",df.getPictureRepresentation());
            
        assertEquals(""+CDate.date(1,12,2007),df.deformat("12 ja 2007"));
        ...
        assertEquals(""+CDate.date(4,12,2007),df.deformat("12 av 2007"));
        assertEquals(""+CDate.date(5,12,2007),df.deformat("12 mai 2007"));
        assertEquals(""+CDate.date(6,12,2007),df.deformat("12 juin 2007"));
        assertEquals(""+CDate.date(7,12,2007),df.deformat("12 juil 2007"));
        assertEquals(""+CDate.date(8,12,2007),df.deformat("12 ao 2007"));
        ...
        assertEquals(""+CDate.date(2,12,2007),df.deformat("12 feb 2007"));
        assertEquals(""+CDate.date(3,12,2007),df.deformat("12 mar 2007"));
        assertEquals(""+CDate.date(4,12,2007),df.deformat("12 avr 2007"));
        assertEquals(""+CDate.date(5,12,2007),df.deformat("12 mai 2007"));
        assertEquals(""+CDate.date(6,12,2007),df.deformat("12 juin 2007"));
        assertEquals(""+CDate.date(7,12,2007),df.deformat("12 juil 2007"));
        assertEquals(""+CDate.date(8,12,2007),df.deformat("12 ao 2007"));
    ...
    public void testFormat()
    {
        ...
        doTestFormat("Jan 27, 2009","### <#, ####","@d3-",CDate.date(1,27,2009)+"");
        doTestFormat("Feb 27, 2009","### <#, ####","@d3-",CDate.date(2,27,2009)+"");
        doTestFormat("Mar 27, 2009","### <#, ####","@d3-",CDate.date(3,27,2009)+"");
        doTestFormat("Apr 27, 2009","### <#, ####","@d3-",CDate.date(4,27,2009)+"");
        doTestFormat("May 27, 2009","### <#, ####","@d3-",CDate.date(5,27,2009)+"");
        doTestFormat("Jun 27, 2009","### <#, ####","@d3-",CDate.date(6,27,2009)+"");
        doTestFormat("Jul 27, 2009","### <#, ####","@d3-",CDate.date(7,27,2009)+"");
        doTestFormat("Aug 27, 2009","### <#, ####","@d3-",CDate.date(8,27,2009)+"");
        doTestFormat("Sep 27, 2009","### <#, ####","@d3-",CDate.date(9,27,2009)+"");
        doTestFormat("Oct 27, 2009","### <#, ####","@d3-",CDate.date(10,27,2009)+"");
        doTestFormat("Nov 27, 2009","### <#, ####","@d3-",CDate.date(11,27,2009)+"");
        doTestFormat("Dec 27, 2009","### <#, ####","@d3-",CDate.date(12,27,2009)+"");

        doTestFormat("January 27, 2009","######### <#, ####","@d4-",CDate.date(1,27,2009)+"");
        doTestFormat("February 27, 2009","######### <#, ####","@d4-",CDate.date(2,27,2009)+"");
        doTestFormat("March 27, 2009","######### <#, ####","@d4-",CDate.date(3,27,2009)+"");
        doTestFormat("April 27, 2009","######### <#, ####","@d4-",CDate.date(4,27,2009)+"");
        doTestFormat("May 27, 2009","######### <#, ####","@d4-",CDate.date(5,27,2009)+"");
        doTestFormat("June 27, 2009","######### <#, ####","@d4-",CDate.date(6,27,2009)+"");
        doTestFormat("July 27, 2009","######### <#, ####","@d4-",CDate.date(7,27,2009)+"");
        doTestFormat("August 27, 2009","######### <#, ####","@d4-",CDate.date(8,27,2009)+"");
        doTestFormat("September 27, 2009","######### <#, ####","@d4-",CDate.date(9,27,2009)+"");
        doTestFormat("October 27, 2009","######### <#, ####","@d4-",CDate.date(10,27,2009)+"");
        doTestFormat("November 27, 2009","######### <#, ####","@d4-",CDate.date(11,27,2009)+"");
        doTestFormat("December 27, 2009","######### <#, ####","@d4-",CDate.date(12,27,2009)+"");
