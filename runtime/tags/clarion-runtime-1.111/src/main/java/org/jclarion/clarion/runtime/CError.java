...
public class CError {
    ...
    {
        return CErrorImpl.getInstance().getFileError();
    }

    public static void pushErrors()
    {
        CErrorImpl.getInstance().pushErorrs();
    }

    public static void popErrors()
    {
        CErrorImpl.getInstance().popErrors();
    }
    ...
    {
    	return CErrorImpl.getInstance().getErrorFile();
    }
    ...
    {
    	return CErrorImpl.getInstance().getFileErrorCode();
    }
