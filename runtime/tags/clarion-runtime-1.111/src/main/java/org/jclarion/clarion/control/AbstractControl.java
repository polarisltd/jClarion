...
public abstract class AbstractControl extends PropertyObject implements RemoteWidget
{
    ...
    protected void doNotifyLocalChange(final int indx,final ClarionObject value) 
    {
        ...
        if (isAWTChange(indx) && isOpened() && (!SwingUtilities.isEventDispatchThread() || getWindowOwner().getWindow()==null)) {
    ...
    */
	...
	public void opened() 
	{
		if (getRawProperty(Prop.WIDTH,false)==null) clearDim=clearDim|1;
		if (getRawProperty(Prop.HEIGHT,false)==null) clearDim=clearDim|2;
	}
}
