...
public class CConfigImpl {
    ...
    public synchronized boolean loadProperties()
    {
        for (int test=0;test<2;test++) {
            ...
            if (test==0 && System.currentTimeMillis()-in.lastModified()>15000) {
                log.severe("Something is wrong - have a severely old .new file. Ignoring it");
                in.delete();
                continue;
            }
    ...
    public synchronized void saveProperties()
    {
        ...
        try {
            ...
            if (out.renameTo(nfile)) {
                ...
                log.severe("Failed to rewrite config");
            }
