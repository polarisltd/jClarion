...
public class OptionControl extends AbstractControl implements SimpleMnemonicAllowed  {
    ...
    {
        add((RadioControl)control,offset);
    }
    
    public void add(RadioControl control,int offset)
    {
    	synchronized(controls) {
    ...
    public List<RadioControl> getChildren()
    {
        return controls;
    }
    ...
    public Collection<RadioControl> getSafeRadioButtons() {
    	synchronized(controls) {
            return new ArrayList<RadioControl>(controls);    		
    	}
    }
    ...
    public void constructSwingComponent(Container parent) {
        ...
        for (final RadioControl rc : getSafeRadioButtons()) {
