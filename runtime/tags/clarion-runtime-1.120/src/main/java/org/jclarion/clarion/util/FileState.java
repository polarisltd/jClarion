...
public class FileState 
{
    ...
    public void saveBuffer(CMem target) {
    ...
    public void restore(FileState save) 
    {
        ...
        this.position=save.position.clone();
	...
	public int index(ClarionObject clarionObject) {
		return getFieldIndex(clarionObject);
	}
