...
public class TextOverlapTest extends TestCase
{
    ...
    public void testTextFlowOverlap() throws InterruptedException
    {
    	...
    	String compare=content+content+content+content+content+content;
    	line.setValue(compare);
    	or.print(rd);
    	or.pageBreak();
    	...
    	while (p.hasNext()) {
    	    ...
    	    String t = ((TextArea)po.getElement(1)).getText();
    	...
    	String c2 = textSoFar.toString().replaceAll("[ \n]"," ").trim();
    	
    	assertEquals(compare,c2);
