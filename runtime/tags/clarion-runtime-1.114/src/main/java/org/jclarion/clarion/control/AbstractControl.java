...
public abstract class AbstractControl extends PropertyObject implements RemoteWidget
{
    ...
    public void reposition()
    {
    	...
    	Rectangle b;
    	b=c.getBounds();
    	b.x=getIntProperty(Prop.XPOS,0,null,b.x,t);
    	b.width=getIntProperty(Prop.WIDTH,0,null,b.width-(i==null ? 0 :i.left+i.right),t);
    	if (b.width<0) {
    		b.x=b.x+b.width;
    		b.width=-b.width;
    	}
    	b.y=getIntProperty(Prop.YPOS,0,null,b.y,t);
    	b.height=getIntProperty(Prop.HEIGHT,0,null,b.height-(i==null ? 0 :i.top+i.bottom),t);
    	if (b.height<0) {
    		b.y=b.y+b.height;
    		b.height=-b.height;
    	}
