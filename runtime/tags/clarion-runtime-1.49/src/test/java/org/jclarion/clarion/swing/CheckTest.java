...
public class CheckTest  extends SwingTC {
    ...
    public void testRenameCheck()
    {
        ...
        assertEquals("Options",cc.getButton().getText());
        Dimension od = cc.getButton().getSize();
        
        cc.setProperty(Prop.TEXT,"More Options");
        waitForEventQueueToCatchup();
        assertEquals("More Options",cc.getButton().getText());
        Dimension nd = cc.getButton().getSize();
    ...
    public void testSimple() throws InterruptedException
    {
        ...
        assertEquals(false,((JCheckBox)cc.getComponent()).isSelected());
            
        val.setValue("True");
        waitForEventQueueToCatchup();

        assertEquals(true,((JCheckBox)cc.getComponent()).isSelected());
        ...
        getRobot().mousePress((Component)cc.getComponent(),5,5);
