...
public class ListTest extends SwingTC 
{
    ...
    public void testFullResize() throws InterruptedException
    {
        ...
        assertApproxSize(c,w.widthDialogToPixels(200),w.heightDialogToPixels(130));

        Container win = w.getWindow();
        ...
        Thread.sleep(100);
        getRobot().mouseMove(win,d.width+w.getFontWidth()*20/4,d.height+w.getFontHeight()*30/8);
        Thread.sleep(100);
        getRobot().mouseRelease();
        ...
        assertApproxSize(c,w.widthDialogToPixels(220),w.heightDialogToPixels(160));
    ...
    public void testTreeFunctions()
    {
        ...
        waitForEventQueueToCatchup();
        assertEquals(6,l.getTable().getSelectedRow());
    ...
    public void testMarkSelect() throws InterruptedException
    {
        ...
        int sel[];
        sel=l.getTable().getSelectedRows();
        ...
        getRobot().mousePress(l.getTable(),30,50);
        getRobot().mouseRelease();
        ...
        Thread.sleep(100);
        getRobot().mousePress(l.getTable(),30,90);
        Thread.sleep(100);
        getRobot().mouseRelease();
        Thread.sleep(100);
