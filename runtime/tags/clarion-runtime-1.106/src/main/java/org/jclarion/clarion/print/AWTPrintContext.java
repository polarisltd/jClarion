...
{
	private static List<CustomRender> renders=new ArrayList<CustomRender>();
	
	public static void register(CustomRender r)
	{
		renders.add(r);
	}
	...
	@Override
	public void drawImage(Page p,String src, int x1, int y1, int width,int height) 
	{
		for (CustomRender r : renders) {
			if (r.drawImage(src, p, g2d, x1, y1, width, height)) return;
		}
	}
